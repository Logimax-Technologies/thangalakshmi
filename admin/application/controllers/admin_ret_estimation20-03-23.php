...
class Admin_ret_estimation extends CI_Controller
{
	...
	*/
	...
	public function getProductBySearch(){
		...
		$data = $this->$model->getProductBySearch($_POST['searchTxt'], $CatCode,$is_non_tag,$id_branch);	  
		echo json_encode($data);
	}
