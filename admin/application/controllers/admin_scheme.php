			...
			case 'Add':
					...
					//echo"<pre>";  print_r($sch_data);exit;
			          ...
			          $sch_info = array(
								...
								'pan_req_amt'		    =>(isset($sch_data['pan_req_amt'])?$sch_data['pan_req_amt']:NULL),
							...
							//  'get_amt_in_schjoin'	 => (isset($sch_data['get_amt_in_schjoin'])?$sch_data['get_amt_in_schjoin']:0),
								...
								'aadhaar_required_amt'		    =>(isset($sch_data['aadhaar_required_amt'])?$sch_data['aadhaar_required_amt']:NULL),
								...
								'no_of_dues'		    =>(isset($sch_data['no_of_dues'])?$sch_data['no_of_dues']:NULL),

								'emp_deduct_ins'		    =>(isset($sch_data['emp_deduct_ins'])?$sch_data['emp_deduct_ins']:0),

								'agent_deduct_ins'		    =>(isset($sch_data['agent_deduct_ins'])?$sch_data['agent_deduct_ins']:0),

								'cus_deduct_ins'		    =>(isset($sch_data['cus_deduct_ins'])?$sch_data['cus_deduct_ins']:0),

								'show_ins_type'				=>(isset($sch_data['show_ins_type'])?$sch_data['show_ins_type']:1),

								'wgt_store_as'				=>(isset($sch_data['wgt_store_as'])?$sch_data['wgt_store_as']:0),

								'disable_pay'               => (isset($sch_data['disable_pay'])?$sch_data['disable_pay']:0),
...

    					{
                    		...
                    		foreach($postData['installmentchart'] as $chartdata){
                                ...
                                $insArrdata = array(
                                    ...
                                    'interest_by'           => $chartdata['interest_by'],    //DGS_DCNM
				...
				// Start of employee & agent incentive benefit 			
						...
						if($sch_data['emp_refferal']==1 || $sch_data['agent_refferal']==1)  
			...
			case 'Edit':
				    ...
				    $sch_info=array(	
							...
							'code'					=>(isset($sch_data['code'])?$sch_data['code']:NULL),
								...
								'discount_installment'	=>(isset($sch_data['discount_installment'])?$sch_data['discount_installment']:0),
                            ...
                            'get_amt_in_schjoin'	 => (isset($sch_data['get_amt_in_schjoin']) && $sch_data['get_amt_in_schjoin'] == 1 && ($sch_data['firstPayamt_maxpayable'] != 0 || $sch_data['firstPayamt_as_payamt'] != 0) ? $sch_data['get_amt_in_schjoin'] : 0),
								...
								'emp_deduct_ins'		    =>(isset($sch_data['emp_deduct_ins'])?$sch_data['emp_deduct_ins']:NULL),

								'agent_deduct_ins'		    =>(isset($sch_data['agent_deduct_ins'])?$sch_data['agent_deduct_ins']:NULL),

								'cus_deduct_ins'		    =>(isset($sch_data['cus_deduct_ins'])?$sch_data['cus_deduct_ins']:NULL),
...

    					{
                    		...
                    		foreach($postData['installmentchart'] as $chartdata){
                                ...
                                $insArrdata = array(
                                    ...
                                    'interest_by'           => $chartdata['interest_by'],

                                    'installment_from'	    => $chartdata['installment_from'],

                                    'installment_to'		=> $chartdata['installment_to'],

                                    'interest_mode' 	    => $chartdata['interest_mode'],
