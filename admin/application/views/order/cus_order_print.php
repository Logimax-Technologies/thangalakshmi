...
<span class="PDFReceipt" >
			...
			<div style="width: 100%; text-transform:uppercase;font-size: 11px !important;">
			    ...
			    <div style="width: 100%; text-transform:uppercase;font-size: 11px !important;text-align:center;margin-top:-45px !important;">
			        <label><b>Customer Order</b></label>
			    </div><p></p>
								...
								<div class="table-responsive">
                                    ...
                                    <tr>
											...
											<tr>
												...
												<th class="table_heading alignRight" style="width: 9%">Due Date</th>
												<th class="table_heading alignRight" style="width: 9%">Status</th>
											</tr>
                                            </thead>
                                            <tr>
        									<td><hr class="item_dashed" style="width:680px !important"></td>
										...
										<tbody>-->
											...
											?>
												<tr>
														...
														<td style="alignRight;"><?php echo $val['cus_due_date'];?></td>
														<td style="alignRight;"><?php echo $val['status'];?></td>
													</tr>
											<?php $i++;
											}?>
											<tr>
