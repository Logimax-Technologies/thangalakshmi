				...
				<?php echo form_open((  $wallet['id_wallet_transaction']!=NULL &&  $wallet['id_wallet_transaction']>0 ?'wallet/transaction/update/'.$wallet['id_wallet_transaction']:'wallet/transaction/save'),array('id'=>'wallet_transaction')) ?>
				 ...
				 <div class="row">
                     ...
                     <!--  <label  for="chargeseme_name" class="col-md-2 col-md-offset-1 ">Transaction Date</label>-->
                       <div class="col-md-4">
                       	 <input type="hidden" class="form-control datemask"  data-date-format="dd-mm-yyyy" id="date_transaction" name="wallet[date_transaction]" value="<?php echo set_value('wallet[date_transaction]',$wallet['date_transaction']); ?>" type="text" />
                        <p class="help-block"></p>                       	
                       </div>
                    </div>
				 </div>		 
				...
				<div class="row">
				 ...
				 <div class="row" >
				 	<div class="form-group" >
                       ...
                       <div class="col-md-4">
                       	<input type="hidden" id="value" class="form-control input_currency" name="wallet[value]" value="<?php echo set_value('wallet[value]',$wallet['value']); ?>" />
                        <p class="help-block"></p>                       	
                       </div>
                    </div>
				 </div>
