	                   ...
	                   <div class="box-body">  
						   <div class="row">
								...
								<div class="col-md-2"> 
									<label></label>
									<div class="form-group">
										<button type="button" id="payment_mode_import_search" class="btn btn-info">Search</button>   
									</div>
								</div>
							</div>
						 </div>
                            ...
                            <div class="row">
                                <div class="box-body">
                                    <div class="table-responsive old_metal" style="">
                                        <table id="pay_mode_list" class="table table-bordered table-striped text-center sales_list" style="width:100%;">
