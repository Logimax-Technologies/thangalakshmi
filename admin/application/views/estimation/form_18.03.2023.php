				...
				<div class="col-sm-12"> 
					...
					<div class="row">	
			    		...
			    		<div class="col-sm-3"> 
				 		...
				 		<div class="col-sm-2 rate_block" <?php echo $emp_setting['allow_manual_rate'] == 0 ? "style='display:none'" : ""  ?>> 
							<input type="checkbox" id="manual_rate" /> &nbsp;<label for="manual_rate">Manual Rate</label>
						</div>
				 	</div> 
                            			   ...
                            			   <div class="table-responsive">
                            				 <table id="total_summary_details" class="table table-bordered table-striped text-center">
                            					...
                            					<tbody>
                            						...
                            						<tr>
                            							<td>Advance Paid Weight</td>
                            							<td><span class="summary_lbl summary_chit_weight"></span></td>
                            							<td>Total Advance Paid Amount</td>
                            							<td><span class="summary_lbl summary_chit_amt"></span></td>
                            						</tr>
                            						...
                            						<tr>
                            							...
                            							<td></td>
                            							<td>Final Price</td>
                            							<td><input type="number" class="form-control total_cost summary_lbl" name="estimation[total_cost]" style="width: inherit;" value="<?php echo set_value('estimation[total_cost]',$estimation['total_cost']); ?>" required readonly>
			...
			<div class="modal-body">
				<div class="row">
					<div class="form-group">
					   <label for="cus_first_name" class="col-md-3 col-md-offset-1 ">First Name<span class="error">*</span></label>
					   <div class="col-md-6">
							<input type="text" class="form-control" id="ed_cus_first_name" name="cus[first_name]" placeholder="Enter customer first name" required="true"> 
