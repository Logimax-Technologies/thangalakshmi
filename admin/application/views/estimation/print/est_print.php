<html><head>
	...
	<?php
	    ...
	    $id_orderdetails ='';
        foreach($est_other_item['item_details'] as $itm)
        {	
        	$id_orderdetails = $itm['id_orderdetails'];
        }
        
        
        
        $total_purchase_amt = 0;
        foreach($est_other_item['old_matel_details'] as $old)
        {
        	$total_purchase_amt+=$old['amount'];
        }
...
<body class="plugin">
	<span class="PDFReceipt">
		<div class="printable">
			...
			<img alt="" src="<?php echo $filename; ?>" style="width:30px;height:30px;">
    			...
    			<div class="item_details">
        			...
        			<table class="estimation" style="width:115%;">
        				...
        				<tbody>
        					...
        					<?php if($tot_adv_paid>0 && $id_orderdetails==''){?>
        			...
        			<?php }}?>
        				...
        				if(sizeof($est_other_item['old_matel_details'])>0 && $id_orderdetails=='' ){?>
        					<div>
        		   ...
        		   <table class="" width="115%">
        		       <tbody>
        		           ...
        		           <tr>
    						...
    						<?php }?>
    						<?php if($total_purchase_amt!=0){?>
    						<tr>
    							
    							<td colspan="4" class="alignRight">Purchase :</td>
    							<td class="alignRight"> <?php echo moneyFormatIndia(number_format(($total_purchase_amt),2,'.',''));?></td>
    						</tr>
    						<?php }?>
    						...
    						<tr style="font-weight:bold;">
    							...
    							<td class="alignRight"> <?php echo moneyFormatIndia(number_format(($tot_payable-$total_purchase_amt-$total_chit_amount),2,'.',''));?></td>
    						</tr>
				   ...
				   <p class="alignRight finalTotal">Rs. <?php echo moneyFormatIndia(number_format(($tot_payable-$total_purchase_amt-$chit_amount-$tot_adv_paid),2,'.',''));?></p>
