			...
			<hr class="dashed">
    			<div class="item_details">
        			...
        			<table class="estimation" style="width:115%;">
						...
						<tr>
						<td><hr class="item_dashed" style="width:625px !important"></td>
						</tr>
        				<!--</thead>-->
        				<tbody>
        					<?php 
							...
							<?php if(sizeof($items['stone_details']) > 0) { ?>
								<?php foreach($items['stone_details'] as $stone) { 
									...
									<tr>
										...
										<td class="alignRight" style="padding-right:10px"><?php echo $stone['pieces'] ?></td>
										<td></td>
										<td class="alignRight"><?php echo $stone['wt'] ?></td>
            				...
            				<tbody>
            					...
            					<tr style="font-weight:bold;">
                					...
                					<tr style="font-weight:bold;">
                						...
                						<td></td>
                						<td></td>
                						<td style="text-align:right;"><?php echo moneyFormatIndia(number_format($tot_payable-$chit_amount-$tot_adv_paid,2,'.',''));?></td>
                					</tr>
        			...
        			<?php }?>
						...
						<tr>
							...
							<td class="alignRight"> <?php echo moneyFormatIndia(number_format(($tot_payable-$tot_purchase-$tot_adv_paid),2,'.',''));?></td>
						</tr>
        			</table>
                    <!--<p></p>
        		   ...
        		   <?php }?>
					<!--<table width="120%">
						<tr >
							...
							<td width="10%"></td>
							<td width="10%"></td>
							<td width="60%" class="alignRight"><span style="font-size: 18px !important">Rs. <?php echo moneyFormatIndia(number_format(($tot_payable-$tot_purchase-$tot_adv_paid),2,'.',''));?></span></td>
						</tr>
