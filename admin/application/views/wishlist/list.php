  ...
  <!-- Content Wrapper. Contains page content -->
            ...
            <div class="col-xs-12">
               ...
               <div class="box box-primary">
			    <div class="box-header with-border">
                  <h3 class="box-title">Wishlist</h3>  <span id="total_data" class="badge bg-green"></span>  
                </div>
                 <div class="box-body">  
				    ...
				    <div class="row">
						<div class="col-md-3"> 
							...
							<button class="btn btn-default btn_date_range" id="account-dt-btn">
								<span  style="display:none;" id="wishlist_list1"></span>
								<span  style="display:none;" id="wishlist_list2"></span>
                 	...
                 	<div class="table-responsive">
	                 	<table id="wishlist_list" class="table table-bordered table-striped text-center">
							<thead>
							<tr>
								<th>Date</th>
								<th>Tag Code</th>
	...
	<div class="modal-dialog">
		...
		<div class="modal-body">
			<div id="wishlist_img" class="col-md-12">
