        ...
        <div class="col-xs-12">
           ...
           <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Enquiry</h3>  <span id="total_data" class="badge bg-green"></span>  
            </div>
             <div class="box-body">  
                ...
                <div class="row">
                    <div class="col-md-3"> 
                        ...
                        <button class="btn btn-default btn_date_range" id="account-dt-btn">
                            <span  style="display:none;" id="enquiry_list1"></span>
                            <span  style="display:none;" id="enquiry_list2"></span>
                 ...
                 <div class="table-responsive">
                     <table id="enquiry_list" class="table table-bordered table-striped text-center">
                        <thead>
                        <tr>
                            <th>Date</th>
                            <th>Customer Name</th>
...
<div class="modal-dialog">
    ...
    <div class="modal-body">
        <div id="enquiry_img" class="col-md-12">
...
<!-- modal -->
<div class="modal fade" id="enquiry-items-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
<div class="modal-dialog">
    <div class="modal-content">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
