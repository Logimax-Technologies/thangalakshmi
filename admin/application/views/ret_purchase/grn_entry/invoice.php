...
<div style="text-align: center">
    <span style="padding-left: 10px; font-weight: bold"><?php echo ($grn_details['grn_type']==1 ? 'TAX INVOICE' : 'METAL RECEIPT')?></span>
</div>
</p>
...
<table width="921" height="766" border="1" cellpadding="3" cellspacing="0">
	<tr>
		...
		<td width="36%" >
			<div style="text-align: right !important; display: inline-block; vertical-align: top;">
				<div style="text-align: left !important;width: 100%; display: inline-block;"> 
						<label><?php echo '<div class="addr_brch_labels">Invoice No</div><div class="addr_brch_values">:&nbsp;&nbsp;'.$grn_details['grn_ref_no']."</div><br>"; ?></label>
						<label><?php echo '<div class="addr_brch_labels">Invoice Date</div><div class="addr_brch_values">:&nbsp;&nbsp;'.$grn_details['grn_date']."</div><br>"; ?></label>
		...
		<td colspan="3" style="padding: 0px; border: none;">
				...
				<table id="commodity_display" border="1" cellpadding="2" cellspacing="0">
					...
					foreach($grn_details['item_details'] as $row) 
					{
					    $stone_cost = 0;
					    $stone_weight = 0;
			            $total_taxable_amt+=($row['grn_net_wt'] * $row['grn_rate_per_grm']);
					...
					?>
						<tr>
							...
							<td  class="desc"><?php echo moneyFormatIndia(number_format($row['grn_net_wt'] * $row['grn_rate_per_grm'],2,'.','')) ?> </td>
						</tr>
					...
					<tr style="font-weight:bold;">
						...
						{?>
						    <td class="rateborders" style="border: 1px solid;"><?php echo moneyFormatIndia(number_format($total_taxable_amt,2,'.','')) ?></td>
						<?php }else{?>
						    <td class="rateborders" style="border: 1px solid;"><?php echo moneyFormatIndia(number_format($total_taxable_amt+$total_charges,2,'.','')) ?></td>
						<?php }?>
					</tr>
