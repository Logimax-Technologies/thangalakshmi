        											...
        											<table id="pp" class="table text-center">
        												<!--	<thead> -->
        														...
        														<tr>
        															...
        															<td class="table_heading" width="20%;">Order No</td>
        												...
        												<?php 
                            							    if(sizeof($order_items)>0)
                            							    {
                            							         foreach($order_items as $ordDetails)
                            							         {
                            							            ...
                            							            {?>
                                								         <figure><a href="<?php echo base_url().'assets/img/orders/'.$image['image'];?>"><img  src="<?php echo base_url().'assets/img/orders/'.$image['image'];?>" width="100" height="100"></a><figcaption><?php echo $image['orderno'];?></figcaption></figure>
