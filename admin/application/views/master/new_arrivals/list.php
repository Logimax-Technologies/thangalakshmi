      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">New Arrivals List</li>
          </ol>
        </section>
            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">New Arrivals List</h3>    <span id="total_new_arrivals" class="badge bg-green"></span>      
                           <a class="btn btn-success pull-right" id="add_new_arrivals" href="<?php echo base_url('index.php/settings/new_arrivals/add');?>" ><i class="fa fa-user-plus"></i> Add</a> 
                </div><!-- /.box-header -->
                <div class="box-body">
                <!-- Alert -->
                <?php 
	            ...
	            <?php } ?>      
                  ...
                  <table id="new_arrivals_list" class="table table-bordered table-striped text-center">
                    <thead>
                      <tr>
                        <th>ID</th>
                        <th>Product Code</th>
