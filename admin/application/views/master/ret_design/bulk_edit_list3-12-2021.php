        ...
        <section class="content product">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">V.A and M.C SETTINGS</h3>
				...
				<div class="col-sm-10"> 
					<div class="row" id="mc_va_block">				    	
						...
						<div class="col-md-6 flexiable_type" style="display:none;">
							<legend><i>Weight range wastage information</i><button id="add_wc_weight_info" type="button" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add Range</button>
					...
					<div class="row" id="attribute_block">
						...
						<div class="col-md-6" id="update_attribute_block">
							<legend><i>Add Attributes</i><button id="add_des_attribute" type="button" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add attribute</button>
							<p class="help-block"></p></legend>
