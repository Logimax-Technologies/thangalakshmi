					...
					<div class="form-group">
					   <label> Flexible Scheme Type </label>
						<select class='form-control' id="pay_type">
							...
							<option   value="4"  <?php if($sch['flexible_sch_type']==4){  ?>selected <?php } ?>>Weight(based on Weight)</option>
                         ...
                         <!--DGS-DCNM -->         
                          ...
                          <tbody>
                            ...
                            //DGS-DCNM ---> add <td> interest_by...
                                  ...
                                  <td>From<input type='number' name='installmentchart[".$key."][installment_from]' class='installment_from' value='".$chart['installment_from']."' style='width: 50px;'>To<input type='number' name='installmentchart[".$key."][installment_to]' class='installment_to' value='".$chart['installment_to']."'  style='width: 50px;'></td><td><input type='radio' name='installmentchart[".$key."][interest_type]' class='interest_type' ". $amtType ." value=1  style='width: 50px;'>Amt<input type='radio' name='installmentchart[".$key."][interest_type]' class='interest_type'  ". $perType ."  value=0  style='width: 50px;'>%</td><td><input type='number' name='installmentchart[".$key."][interest_value]' value='".$chart['interest_value']."' class='form-control interest_value' style='width: 100px;'   style='width: 100px;'></td><td><div><button id='" .$key. "' class='delete btn btn-danger'  name='delete'type='button'><i class='fa fa-trash'></i> REMOVE</button></div></td></tr>";
	...
	<legend><a  data-toggle="tooltip" title="Select Employee & Agent Incentive Benefits">Employee & Agent Incentive Benefits</a></legend>
		<div class="form-group">
			...
			<div class="col-md-2 emp_incentive_block" style="<?php echo $sch['emp_refferal'] == 1 ? "" : "display: none;" ;?>">
				   ...
				   <div class="col-sm-2 emp_incentive_block" style="<?php echo $sch['emp_refferal'] == 1 ? "" : "display: none;" ;?>">
