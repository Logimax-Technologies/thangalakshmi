      ...
      <div class="content-wrapper">
			...
			<div class="col-md-10 col-md-offset-1">
				...
				<div class="row">
			    	...
			    	<div class="col-md-12">
				    	...
				    	<div <?php if($discount['free_first_payment']==1) { ?> class="form-group col-md-3" <?php }else{ ?> class="form-group col-md-3" <?php } ?>>
       ...
       data-off-text="NO" name="sch[active]" value="1" <?php if($sch['active']==1) { ?> checked="true" <?php } ?>/>
		...
		<br />
					 ...
					 <div class="row">
				    <div class="form-group">
					   <label for="chargeseme_name" class="col-md-3 col-md-offset-1">Upload scheme image</label>
					   <div class="col-md-6">
...
<legend> <a  data-toggle="tooltip" title="Enter Your Scheme Details">Scheme Detail</a></legend> 
					...
					if($sch['id_scheme']==NULL){ ?>
						<div class="col-sm-3">
							<div class="form-group"> 
									 ...
									 <label for="Branch" class=""> <a  data-toggle="tooltip" title="Enter Scheme Name"> Branch</a></label>
			...
			<legend> <a  data-toggle="tooltip" title="Select Your Scheme Details">Scheme Type</a></legend> 
						   ...
						   <div class="form-group">
						   	   ...
						   	   <div class="col-md-3">	
								   ...
								   <label>
									   ...
									   <input type="radio" id="opt_amount"  name="sch[scheme_type]" value="0" class="minimal" <?php if($sch['scheme_type']==0){ ?> checked <?php } ?>/>
	                      ...
	                      Amount
							   ...
							   <div class="col-md-3">	
									...
									<label>									  		
									  ...
									  <input type="radio" id="opt_weight"  name="sch[scheme_type]" value="1" class="minimal" <?php if($sch['scheme_type']==1){ ?> checked <?php } ?>/>
	                      ...
	                      Weight
							   ...
							   <div class="col-md-3">	
									...
									<label>									  		
									  ...
									  <input type="radio" id="opt_amtToWgt"  name="sch[scheme_type]" value="2" class="minimal" <?php if($sch['scheme_type']==2){ ?> checked <?php } ?>/>
	                      ...
	                      Amount to weight
							...
							<div class="col-md-3">	
									...
									<label>									  		
									  ...
									  <input type="radio" id="opt_flexible amount"  name="sch[scheme_type]" value="3" class="minimal" <?php if($sch['scheme_type']==3){ ?> checked <?php } ?>/>
		    	...
		    	<div class="box">
					...
					<div class="box-body">
					 ...
					 <!--<div class="row">
					 	...
					 	<small class="col-md-offset-3" id="type">asdasdasd asdasdasd</small>
		...
		<legend><a  data-toggle="tooltip" title="Enter Your Scheme Amount Deatils">Payment </a></legend>
			...
			<div class="row">
				  ...
				  <div class="col-md-12">				  
                   ...
                   <legend style="color:red">Mandatory</legend>
		...
		<div id="paymenttype_settings" style="display:none">		
		  ...
		  <div class="row">
			...
			<div class="col-sm-offset-0 col-sm-11">
				...
				<legend><a  data-toggle="tooltip" title="Scheme Payment Amount Chance ">Payment Chances</a></legend>				 
	      	</div>
	     </div>
	

	<div id="paymentmethod_settings" style="display:none">		
		 <div class="row">
			...
			<div class="col-sm-offset-0 col-sm-11">
				...
				<div class="col-sm-offset-1 col-sm-4">
					  ...
					  <legend><a  data-toggle="tooltip" title="Select scheme payment type  mothly or daily">Payment Types</a></legend>
			...
			<!--	<div id="wgt_cnvrt">-->
					...
					<div class="col-sm-offset-1 col-md-6">
					  ...
					  <legend><a  data-toggle="tooltip" title="Select sheme payment Weight convert  mothly or daily">Weight Convert</a></legend>			
					...
					<div class="col-sm-offset-1 col-sm-4">
						...
						<div class="form-group">
						   ...
						   <div class="col-md-6">
							   ...
							   <label style="margin-top: 63px;">

								   <input type="radio" id="pay_single" name="sch[payment_chances]" class="minimal" <?php if($sch['payment_chances']==0){  ?> checked<?php } ?> value="0"/>
	                      ...
	                      Single
						   ...
						   <div class="col-md-6">		
							 ...
							 <input type="radio" id="pay_multiple" name="sch[payment_chances]" class="minimal" <?php if($sch['payment_chances']==1){  ?> checked<?php } ?> value="1"/>
						...
						<div class="col-sm-offset-1 col-md-6">
							   ...
							   <legend><a  data-toggle="tooltip" title="Set your scheme payment Chances limit ">Payment Limit</a></legend>
		...
		<div id="weighttye_settings" style="display:none;">
			 ...
			 <div class="row">
				 ...
				 <div class="col-sm-offset-1 col-sm-11">
					...
					<div class="col-sm-offset-1 col-sm-3">
					   ...
					   <label style=" margin-top: 75px;">Weight Limit</label> 
					</div>
	...
	<div id="paymentamount_limit" style="display:none;">
		<div class="row">
			 ...
			 <div class="col-sm-offset-1 col-sm-11">						 
			      ...
			      <div class="col-sm-offset-1 col-sm-3"> 
				    ...
				    <label style="margin-top: 75px;">Amount Limit</label> 
			      </div>
			      <div class="col-sm-offset-1 col-md-6">
		 ...
		 <div class="row">
			...
			<div class="col-sm-offset-0 col-sm-11">
				...
				<div class="col-sm-offset-1 col-sm-4">
					  ...
					  <legend><a  data-toggle="tooltip" title="Select scheme payment type  mothly or daily">Price Fixing</a></legend>
	                 ...
	                 <div class="form-group">
						  ...
						  <div class="col-sm-6">
							   ...
							   <label style="margin-top: 25px;">
								   ...
								   <input type="radio" id="otp_price_fix_type" name="sch[otp_price_fix_type]"  class="minimal" <?php if($sch['otp_price_fix_type']==1){  ?> checked<?php } ?> value="1"> 
	                      ...
	                      Single
						   ...
						   <div class="col-sm-6">	
							 ...
							 <input type="radio" id="otp_price_fix_type" name="sch[otp_price_fix_type]"  class="minimal" <?php if($sch['otp_price_fix_type']==2){  ?> checked<?php } ?>value="2" > 
	 ...
	 <div class="row">
			...
			<div class="form-group"> 
				...
				<div class="col-sm-8" style="margin-top: 29px;">
				  <div class="col-sm-4">
					   <input type="radio"  name="sch[charge_type]" class="minimal interest_block" <?php if($sch['charge_type']==0){  ?>checked <?php } ?> value="0"/> Percentage
				   </div> 
				   <div class="col-sm-4">
					   <input type="radio" name="sch[charge_type]" class="minimal interest_block"  <?php if($sch['charge_type']==1){  ?>checked <?php } ?> value="1"/>
					  Amount 
				   </div> 
				   <div class="col-sm-4">
					<input type="text" class="form-control interest_block"  name="sch[charge]" value="<?php echo set_value('sch[charge]',$sch['charge']); ?>" /> 
				   </div>
					      ...
					      <div class="form-group ">
						    ...
						    <div class="col-sm-4">
    				    	  ...
    				    	  <label>
    				    		...
    				    		<input type="checkbox"  id="allowSecondPay" name="sch[allowSecondPay]" value="1" <?php if($sch['allowSecondPay']==1) { ?> checked="true" <?php } ?>/><span  data-toggle="tooltip" title="Allow 2nd ins payment">Allow Second Pay </span>
                             ...
                             <div class="form-group ">
    						    ...
    						    <div class="col-sm-4">
        				    	  ...
        				    	  <label>
        				    		...
        				    		<input type="checkbox"  id="approvalReqForFP" name="sch[approvalReqForFP]" value="1" <?php if($sch['approvalReqForFP']==1) { ?> checked="true" <?php } ?>/><span  data-toggle="tooltip" title="Allow 2nd ins payment">Approval required for Free Payment </span>
				...
				<div class="row">
				   ...
				   <div class="col-sm-offset-1 col-sm-11">
				 	...
				 	<div class="form-group">
                      ...
                      <div class="col-sm-9" style="margin-left: -86px;">
						  <div class="col-sm-3">
							<label>
						   ...
						   <div class="col-sm-3">
							...
							<input type="text" style="margin-left: -13px;"class="form-control" id="emp_refferal_value" name="sch[Emp_ref_values]" value="<?php echo set_value('sch[Emp_ref_values]',$sch['Emp_ref_values']); ?>" /> 
						   </div>
					  </div> 
				...
				<div class="row">
				   ...
				   <div class="col-sm-offset-1 col-sm-11">
				 	...
				 	<div class="form-group"> 
                      ...
                      <div class="col-sm-9" style="margin-left:-98px;">
						 <div class="col-sm-3">
						   ...
						   <div class="col-sm-3">
							<label>
							  <input type="radio" name="sch[cus_refferal_by]" style="
    margin-left: 12px; "class="minimal" <?php if($sch['cus_refferal_by']==1){  ?>checked <?php } ?> value="1"  />
							  Amount 
							</label>
						   </div> 
						   <div class="col-sm-3">
				...
				<!-- START OF GST Settings -->
	             <legend>GST Settings</legend>
			      ...
			      <!-- END OF GST Settings -->
				   ...
				   <legend><a  data-toggle="tooltip" title="Enter The Scheme Description"> Description</a></legend>
