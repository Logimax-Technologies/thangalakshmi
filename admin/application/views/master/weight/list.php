      ...
      <div class="modal-body">
          <div class="row">
				 	<div class="form-group">
                       ...
                       <div class="col-md-4">
<input type="text" class="form-control" id="weight" onkeypress="return /^[0-9]$/i.test(event.key)" name="weight" value="<?php echo set_value('weight',(isset($wt)?$wt:"")); ?>" placeholder="Enter Weight">                   <p class="help-block"></p>
...
<input type="text" class="form-control" id="ed_weight" onkeypress="return /^[0-9]$/i.test(event.key)" name="weight" value="<?php echo set_value('weight',(isset($wt)?$wt:"")); ?>" placeholder="Enter Weight">                   <p class="help-block"></p>
