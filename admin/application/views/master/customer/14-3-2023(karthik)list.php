            ...
            <div class="col-xs-12">
               ...
               <div class="box box-primary">
			    <div class="box-header with-border">
                  <h3 class="box-title">Customer List</h3>  <span id="total_customers" class="badge bg-green"></span>
                  <div class="pull-right">
                  	 <a class="btn btn-success pull-right" id="add_customer" href="<?php echo base_url('index.php/customer/add');?>" ><i class="fa fa-plus-circle"></i> Add</a>
				  </div>
                </div>
                 <div class="box-body">
   				   <div class="row">
		                ...
		                <div class="col-sm-2">
		                    <br/>
		                    <button type="submit" class="btn btn-success" id="bulk_allocate_agent"><i class="fa fa-envelope-o"></i>Allocate To Agent</button>
		                </div>
   				   </div>
					<div class="row">
						<div class="col-md-1">
							<div class="form-group">
							<button id="btnExport" onclick="fnCusItemsExcelReport('1');" class="btn btn-success "><i class="fa fa-file-excel-o"></i>&nbsp;</button>
							</div>
						</div>
					</div>
			 <br/>
...
<div class="modal fade" id="allocate_agent_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
<div class="modal-dialog">
<div class="modal-content">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
