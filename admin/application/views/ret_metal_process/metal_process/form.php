								        ...
								        <div class="table-responsive tagged_item_melting_details" style="display:none;">
								             <table id="tagged_pocket_details" class="table table-bordered table-striped text-center">
								                 <thead>
										          ...
										          <tbody></tbody>
										           <tfoot>
										               <tr style="font-weight:bold;"><td>Total</td><input type="hidden" class="total_pcs" name="process[tag_piece]"><input type="hidden" class="tot_gross_wt" name="process[tag_gross_wt]"><input type="hidden" class="tot_net_wt" name="process[tag_net_wt]"><input type="hidden" class="tot_avg_purity" name="process[tag_purity]"><input type="hidden" class="tag_tot_amount" name="process[tag_amount]"><td></td><td class="tot_pcs"></td><td class="tot_gwt"></td><td class="tot_nwt"></td><td class="tot_purity"></td><td class="tot_value"></td><td></td></tr>
										           </tfoot>
								             </table>
								        </div>
								        ...
								        <div class="table-responsive non_tagged_item_melting_details" style="display:none;">
								             <table id="non_tagged_pocket_details" class="table table-bordered table-striped text-center">
								                 <thead>
										          ...
										          <tbody></tbody>
										           <tfoot>
										               <tr style="font-weight:bold;"><td>Total</td><input type="hidden" class="total_pcs" name="process[non_tag_piece]"><input type="hidden" class="tot_gross_wt" name="process[non_tag_gross_wt]"><input type="hidden" class="tot_net_wt" name="process[non_tag_net_wt]"><td></td><td class="tot_pcs"></td><td class="tot_gwt"></td><td class="tot_nwt"></td><td></td></tr>
										           </tfoot>
								             </table>
								        </div>
