            ...
            <div class="col-xs-12">
               ...
               <div class="box box-primary">
			    <div class="box-header with-border">
                  <h3 class="box-title">Pocket List</h3>  <span id="total_estimation" class="badge bg-green"></span>  
                  <div class="pull-right">
                  	 <a class="btn btn-success pull-right" id="add_estimation" href="<?php echo base_url('index.php/admin_ret_metal_process/metal_pocket/add');?>" ><i class="fa fa-plus-circle"></i> Add</a> 
				  </div>
                </div>
                 <div class="box-body">  
