		...
		<div class="address" align="right"> 
			...
			<table class="meta" style="width: 40%" align="right">
				...
				<tr>
					...
					<?php if($records[0]['paid_installments'] == 1){  ?>
					    <td><span><?php echo ($records[0]['paid_installments'].'/'.$records[0]['total_installments']); ?></span></td>
					<?php }else{  ?>
			...
			<div class="useraddr"><p><?php echo $records[0]['firstname'].' '.$records[0]['lastname'].(isset($records[0]['firstname'])?',':''); ?></p>
				<p > <?php echo $records[0]['address1']; ?> </p>
				 ...
				 <?php $show_wgt = ($records[0]['scheme_type']== 1 || $records[0]['scheme_type']==2 || $records[0]['flexible_sch_type'] !=1 ) ? TRUE : FALSE ; ?>
			<table class="inventory">
				...
				<tbody>-->
					...
					<tr>
						<td colspan="<?php echo ( $show_wgt ? 4 : 2) ?>"><?php echo ucwords($records[0]['amount_in_words']); ?> Only</td>
					</tr>
