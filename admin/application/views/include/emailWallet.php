					...
					<font size="2" face="Open-sans, sans-serif" color="#555454">
						<p data-html-only="1" style="border-bottom:1px solid #D6D4D4;margin:3px 0 7px;text-transform:uppercase;font-weight:500;font-size:18px;padding-bottom:10px;">
							...
							<span style="color:#777">
							 Your <?php echo $company['company_name']?> saving scheme wallet account is successfully created for your account.<br /><br />
				...
				<td style="padding:7px 0">
					<font size="2" face="Open-sans, sans-serif" color="#555454">
						<p data-html-only="1" style="border-bottom:1px solid #D6D4D4;margin:3px 0 7px;text-transform:uppercase;font-weight:500;font-size:18px;padding-bottom:10px;">
							...
							<span style="color:#777">
							 Your <?php echo $company['company_name']?> saving scheme wallet transaction is successfully processed.<br /><br />
