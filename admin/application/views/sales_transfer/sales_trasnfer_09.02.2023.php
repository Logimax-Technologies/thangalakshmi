                                                ...
                                                <div class="col-md-5">    
                                                 <div class="form-group tagged sales_trans"> 
                                                    ...
                                                    <div class="col-md-5">
                                                      ...
                                                      <div class="form-group sales_trans_download"
                                                          style="display:none;">
                                                          <div class="row">
                                                              <div class="col-md-offset-5 col-md-7">
                                                                  <button type="button"
                          ...
                          <div class="col-md-12">
                              ...
                              <div class="table-responsive">
                                  <table id="bt_search_list" class="table table-bordered table-striped text-center">
                                      ...
                                      <tbody></tbody>
                                      <tfoot><tr style="font-weight:bold;"><td>TOTAL</td><td class="tot_bt_pcs"></td><td class="tot_bt_gross_wt"></td><td></td><td></td><td></td><td></td></tr></tfoot>
                                  </table>
                              </div>
                          </div>
                      </div>
