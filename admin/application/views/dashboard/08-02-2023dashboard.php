				...
				<div class="col-md-4">  
					...
					<div class="form-group">
					   <button class="btn btn-default btn_date_range" id="payment-dt-btn"> 
						...
						<label id="payment_show1"></label> -
						<label id="payment_show2"></label>
					</div> 
				 </div>	
			                ...
			                <div class="box-body no-padding">
			                  <table class="table table-condensed">
			                    <tr>
								  ...
								  <td style="text-align:right;"><?php echo '&#8377;'.(isset($due['today_due']['amount'])?$due['today_due']['amount']:'0');?></td>
			                    </tr> 
								...
								<tr>
								  ...
								  <td style="text-align:right;"><?php echo '&#8377;'.(isset($due['yesterday_due']['amount'])?$due['yesterday_due']['amount']:'0');?></td>
			                    </tr>
								...
								<tr>
								  ...
								  <td style="text-align:right;"><?php echo '&#8377;'.(isset($due['week_due']['amount'])?$due['week_due']['amount']:'0');?></td>
			                    </tr>
								<tr>
			                      <td>This Month</td>
								  ...
								  <td style="text-align:right;"><?php echo '&#8377;'.(isset($due['month_due']['amount'])?$due['month_due']['amount']:'0');?></td>
			                    </tr>								
			                    <!--<tr>
