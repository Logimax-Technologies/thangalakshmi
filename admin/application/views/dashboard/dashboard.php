  ...
  <div class="row">
	...
	<div align="left"  style="background: #f5f5f5">
		<ul class="nav nav-tabs">
			...
			<li id="tab_contract_pricing"><a href="#contract_pricing" data-toggle="tab">Contract Pricing</a></li> 
	    </ul>
	</div>
	...
	<br/>
		...
		<div class="tab-pane" id="contract_pricing">
          ...
          <div class="row crm">
				<div class="col-lg-3 col-xs-6">
						<div class="info-box bg-pink ">
											<span class="info-box-icon"><i style="color:white;" class="fa fa-birthday-cake"></i></span>
            ...
            <div class="col-lg-3 col-xs-6">
             <div class="info-box bg-green">
			   ...
			   <?php if($this->session->userdata('branch_settings')!=0){?>
					<span class="info-box-text" style="display: flex; 
							justify-content: center;align-items: center; font-size: 25px;margin-top:20px;">Payments</span>
				<?php }else{ ?>
   ...
   <div id="accounts">
            <div class="col-lg-3 col-xs-6" >
              <div class="info-box bg-aqua">
			   ...
			   <?php if($this->session->userdata('branch_settings')!=0){?>
					<span class="info-box-text" style="display: flex; 
						justify-content: center;align-items: center; font-size: 25px;margin-top:20px;">Accounts</span>
				<?php }else{ ?>
           ...
           <div class="col-lg-3 col-xs-6">
              ...
              <div class="info-box bg-yellow">
				...
				<?php if($this->session->userdata('branch_settings')!=0){?>
                  <span class="info-box-text" style="display: flex; 
       				justify-content: center;align-items: center; font-size: 25px;margin-top:20px;">Customers</span>
				<?php }else{ ?>
				...
				<div class="col-md-3">
					...
					<div class="info-box bg-blue">
                        ...
                        <div class="info-box-content">
						  ...
						  <span class="info-box-text" style="display: flex; 
       				justify-content: center;align-items: center; font-size: 20px;margin-top:20px;">Closed Accounts</span>
			...
			<?php if($this->session->userdata('id_branch')==''){?>
			   ...
			   <div class="info-box bg-red">    <!-- Customer Feedback-->
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-text" style="display: flex; 
       				justify-content: center;align-items: center; font-size: 18px;margin-top:20px;">Customer Feedback</span>
