        ...
        <section class="content">
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Import Payment Data</h3>
            ...
            <div class="box-body">
              <div>
               <?php 
	            ...
	            <?php } ?>      
		        <?php echo form_open_multipart('settings/import/payment_data');?>
				 ...
				 <div class="row">
				 	<div class="form-group">
                       <label for="scheme_code" class="col-md-2 col-md-offset-1 ">Payment Approved</label>
                       <div class="col-md-4">
                       	 <input type="checkbox"  id="send_sms" name="import[pay_status]"  data-on-text="YES" data-off-text="NO" value="1"> 
                  <p class="help-block"></p>
