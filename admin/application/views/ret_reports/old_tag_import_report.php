  ...
  <div class="content-wrapper">
      ...
      <section class="content-header">
          <h1>
              Old Tag Import Report
          </h1>
          <ol class="breadcrumb">
              <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
              <li><a href="#">Inventory</a></li>
              <li class="active">Old Tag Import Report</li>
          </ol>
      </section>
      ...
      <section class="content">
          <div class="row">
			...
			<div class="col-md-3">
			  <input type="radio" class = "is_check_import_type" id = "click_label_yes" name="is_check_import_type" value="1"><label for="click_label_yes">&nbsp;&nbsp;Tags</label>&nbsp;&nbsp;
			  &nbsp;&nbsp;
			  <input type="radio" class = "is_check_import_type" id = "click_label_no" name="is_check_import_type" value="2"><label for="click_label_no">&nbsp;&nbsp;Stones</label>
			</div>	
			</div>
							   </div>
							   <div class="row">
							   <div class="form-group">
                                                  ...
                                                  <form id="import_tags" method="post" enctype="multipart/form-data">
          ...
          <div class="col-md-3">
              <button name="upload" id="upload" value="Upload" onclick="import_tagas()" class="btn btn-success" style="margin-top:27px;margin-left:72px;">Upload</button>
              <!-- onclick="reloads()" -->
          </div>
                                  ...
                                  <div class="box box-default">
                                      <div class="box-body">
                                          ...
                                          <div class="row">
                                              ...
                                              <div class="col-md-6">
                                                <div class="form-group"><a style="font-size: 16px;font-weight: bold;text-align: center;vertical-align: middle;" href="<?php echo base_url(); ?>assets/upload/old_tag_files/sampletagimportformat.xlsx" download="Sample Tag Import">Download Tag Import Format</a></div>
                                              </div>
                                          </div>
                                      </div>
                                  </div>
