            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Product List</h3>    <span id="total_offers" class="badge bg-green"></span>      
                           <a class="btn btn-success pull-right" id="add_offer" href="<?php echo base_url('index.php/catalog/product/add');?>" ><i class="fa fa-user-plus"></i> Add</a> 
                </div><!-- /.box-header -->
                <div class="box-body">
                <!-- Alert -->
                <?php 
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
               <strong>Are you sure! You want to delete this Product record?</strong>
      </div>
