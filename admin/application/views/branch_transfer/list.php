        ...
        <section class="content-header">
          <h1>
           Branch Transfer List
            <small>Manage Branch Transfer(s)</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Branch Trasnfer List</a></li>
            <li class="active">Branch Transfer List</li>
          </ol>
        </section>
        <!-- Main content -->
            ...
            <div class="col-xs-12">
               <div class="box box-primary">
			    <div class="box-header with-border">
                  <h3 class="box-title">Branch Trasnfer List </h3>  <span id="total_billing" class="badge bg-green"></span>  
                  <button class="btn btn-default btn_date_range" id="account-dt-btn">
                   ...
                   <div class="pull-right">
                      	 ...
                      	 <a class="btn btn-success pull-right" id="add_estimation" href="<?php echo base_url('index.php/admin_ret_brntransfer/branch_transfer/add');?>" ><i class="fa fa-plus-circle"></i> Add</a> 
    				  </div>
                    </div>
