              		...
              		<div class="row">
	              		...
	              		<div class="col-sm-6">
	              			 ...
	              			 <div class="form-group">
	              					...
	              					<input type="text" class="form-control" name="account[account_name]" id="account_name" value="<?php echo set_value('account[account_name]',$account['name']); ?>" readonly="true"/>
         		...
         		<div class="col-sm-4">
              	...
              	<div class="col-sm-4">
              		...
              		<div class="form-group">
              			...
              			<label for="" style="color:#FF0000;"><?php echo ($account['scheme_type']=='Amount'?'<a  data-toggle="tooltip" title="Amount after interest & tax calculation" style="color:#FF0000;">Closing Balance</a>':'Closing Weight')?> </label>
			...
			<div class="row" >
			    	...
			    	<div class="col-md-4">
			    		...
			    		<div class='form-group'>
			                ...
			                <input type="text" id="otp" name="account[otp]" required="true" class="form-control" disabled="true" />
