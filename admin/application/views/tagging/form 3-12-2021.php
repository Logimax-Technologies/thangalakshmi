				 		        	...
				 		        	<div class="row">
							 			...
							 			<div class="col-sm-7">
							 				...
							 				<div class="form-group"> 
						 		        		...
						 		        		<input id="tag_huid" class="form-control custom-inp" type="text" step="any" value="" tabindex="13" />
									 ...
									 <div class="row">
							 			...
							 			<div class="col-sm-7">
							 				...
							 				<div class="form-group"> 
						 		        		...
						 		        		<input id="manufacture_code" class="form-control" type="text" tabindex="16" />
									...
									<div class="row">
							 			...
							 			<div class="col-sm-7">
							 				...
							 				<div class="form-group"> 
						 		        		...
						 		        		<input id="style_code" class="form-control" type="text" tabindex="17" />
									 ...
									 <div class="row">
							 			...
							 			<div class="col-sm-7">
							 				...
							 				<div class="form-group"> 
						 		        		...
						 		        		<input id="remarks" class="form-control" type="text" tabindex="18" />
									...
									<br/>
						 			...
						 			<div class="row">
							 			...
							 			<div class="col-sm-12" align="center"> 
							 				...
							 				<button type="button" id="addTagToPreview" class="btn btn-success btn-flat" tabindex="19">Add</button>

							 				<button style="display: none;" type="button" disabled id="addTagToPreviewAndCopy" class="btn btn-info btn-flat">Add & Copy</button>

							 				<button type="button" style="display: none" id="updateTagInPreview" class="btn btn-primary btn-flat" tabindex="20">Update</button>

							 				<button type="button" id="reset_tag_form" class="btn btn-default btn-flat" tabindex="20" >Reset</button>
