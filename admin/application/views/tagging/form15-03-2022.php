				...
				<div class="col-sm-12"> 
					...
					<div class="row">				    	
									...
									<div class="row">
							 			...
							 			<div class="col-sm-7">
							 				...
							 				<div class="form-group"> 
						 		        		...
						 		        		<input id="tag_purchase_cost" class="form-control" type="number" tabindex="20" />
									...
									<br/>
						 			...
						 			<div class="row">
							 			...
							 			<div class="col-sm-12" align="center"> 
							 				...
							 				<button type="button" id="addTagToPreview" class="btn btn-success btn-flat" tabindex="21">Add</button>
				 	...
				 	<div class="row stickyBlk" style="display: none;">
				    	...
				    	<div class="row">
				 	        <div class="col-md-2">
    				 	        <select class="form-control to_branch"  id="branch_select"></select>
    				 	    </div>
    				 	    <div class="col-md-2">
