				...
				<div class="col-sm-12"> 
					...
					<legend class="sub-title">Tag Details</legend>
				 	...
				 	<div class="row stickyBlk" >
				 		<div class="col-md-12">
				 		    <div class="col-md-2">
				 		        <button type="button"  id="add_more_tag" class="btn btn-success">Add Tag</button>
				 		    </div>
				 			<div class="col-md-2">
				 		        <input type="number" class="form-control" id="row_value" placeholder="Enter No.of Rows">
				 		    </div>
				 		    <div class="col-md-2">
				 		        <button type="button"  id="add_multiple_tag" class="btn btn-success">Copy Rows</button>
				 		    </div>
				 		</div> 
				 	</div>
				 	<p></p>
