...
$tot_sales_amt  =  number_format(round($sales_cost),2,'.','');
    ...
    <div>
	    	...
	    	<div style="width: 100%; text-align: right; text-transform:uppercase;display: inline-block;margin-top:-40px;">
			    <div style="text-align: right; width:100%;height: 18px;">
					...
					<div style="width: 10%; display: inline-block; margin-top: -2px"> <b><?php echo $billing['bill_date']; ?></b></div>
				</div>
				<div style="text-align: right; width:100%;height: 18px;">
											...
											<div class="table-responsive">
												<table id="pp" class="table text-center">
													...
													<tr>
														...
														<td><?php echo $billing['tot_bill_amount'];?></td>
													</tr>
													<tr>
														<td><hr class="old_metal_dashed"></td>
													</tr>
