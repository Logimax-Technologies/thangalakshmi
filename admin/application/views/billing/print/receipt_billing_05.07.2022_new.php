...
?>
    <div style="margin-top:23px !important;">
			...
			<div style="text-align: left;width: 100%; text-transform:uppercase;margin-top:-65px;">
	    	...
	    	<div style="width: 100%; text-align: right; text-transform:uppercase;display: inline-block;margin-top:-70px;margin-right:-50px">
		 	...
		 	<div style="width: 100%; text-align: center; margin-top:-3%; font-weight: bold; text-transform:uppercase;">
				<label>
					<?php echo "TAX INVOICE - ".($billing['bill_type']==1 ? 'Sales': ($billing['bill_type']==2 ? 'Sales And Purchase':($billing['bill_type']==3 ? 'Sales and purchase' :($billing['bill_type']==4 ? 'Purchase Bill':($billing['bill_type']==5 ? 'Order Advance' :($billing['bill_type']==6 ? 'Advance' :($billing['bill_type']==7 ? 'Sales Return':($billing['bill_type']==9 ? 'Order Delivery' :($billing['bill_type']==10 ? 'Chit PreClose': ($billing['bill_type']==11 ? 'Repair Order' : 'Credit Collection') ))))))))).($billing['bill_status']==2 ? '- Cancelled' : '');?>
				</label>
			</div>
			<p></p><p></p>
