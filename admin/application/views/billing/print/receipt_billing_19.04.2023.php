		...
		<span class="PDFReceipt">
			...
			<div class="maindiv" style="margin-top:0px !important; ">
				...
				<div class="right">
					...
					<div style="text-align: left !important;width: 100%; display: inline-block; font-weight:bold">
						...
						<div style="display:none"><img width="60" height="60" src="F:\xampp\htdocs\etail_v5\admin\assets\img\billing\02090.jpeg"></div>
				...
				<div style="width: 100%; text-transform:uppercase;">
					...
					<div style="display: inline-block; width: 35%; padding-left:0px;">
						<label><?php echo ($billing['goldrate_18ct'] != 0 ? '<div class="rate_labels" style="height: 18px;"></div><div class="addr_values" style="height: 18px;">&nbsp;&nbsp;' . "</div>" : ''); ?></label><br>


						<br>


						<label><?php echo '<div class="rate_labels" style="height: 18px;"></div><div class="addr_values" style="height: 18px;">&nbsp;&nbsp;' . "</div>"; ?></label><br>
					</div>

					<div align="center" style="display: inline-block; width: 22%;padding-left:40px;font-weight: bold; text-align:center !important; padding-top:70px">
						...
						<?php $purchase_old_metal_type =0; ?>
							...
							<!--<?php  echo $billing['bill_type'] != 15 ? "  " . ($billing['bill_type'] == 1 ? 'Sales Bill' :
		 					( $billing['bill_type'] == 2   ? ($purchase_old_metal_type == 1 ? 'Sales & Old Gold  Purchase ' : ($purchase_old_metal_type==2 ? 'Sales & Old Silver Purchase' : 'Sales & Purchase')) :
							  ($billing['bill_type'] == 14 ? "Sales Return Transfer" :
							   ($billing['bill_type'] == 3 ?   'Sales & Credit Sales ' :
							    ($billing['bill_type'] == 4 ? ($purchase_old_metal_type==1 ? 'Old Gold Purchase Bill': $purchase_old_metal_type==2 ? 'Old Silver Purchase Bill' : 'Purchase Bill' ):
								 ($billing['bill_type'] == 5 ? 'Order Advance' :
								  ($billing['bill_type'] == 6 ? 'Advance' : ($billing['bill_type'] == 7 ? 'Sales Credit' : ($billing['bill_type'] == 9 ? 'Order Delivery' : ($billing['bill_type'] == 10 ? 'Chit PreClose' : ($billing['bill_type'] == 11 ? 'Repair Order' : ($billing['bill_type'] == 13 ? 'Sales Transfer' : ($billing['bill_type'] == 15 ? 'Approval Bill Acknowledgement' : 'Credit Collection'))))))))))))) . "" : ($billing['bill_status'] == 2 ? '- Cancelled' : '') ?>
						-->
						
                            <?php echo $billing['bill_type'] != 15 ? "  " . 
                            ($billing['bill_type'] == 1 ? ($billing['is_to_be'] == 1 ? 'To Be Sales Bill' : ($billing['is_credit']==1 ?'Credit Sales Bill' : 'Sales Bill')):
                            ($billing['bill_type'] == 2   ? ($metal_name!='' ? 'Sales & Old '.$metal_name.' Purchase ' :'Sales & Purchase') : ($billing['bill_type'] == 14 ? "Sales Return Transfer" : ($billing['bill_type'] == 3 ?   'Sales & Credit Sales ' : ($billing['bill_type'] == 4 ? ($metal_name!='' ? 'Old '.$metal_name.' Purchase Bill': 'Purchase Bill') : ($billing['bill_type'] == 5 ? 'Order Advance' : ($billing['bill_type'] == 6 ? 'Advance' : ($billing['bill_type'] == 7 ? 'Sales Credit' : ($billing['bill_type'] == 9 ? 'Order Delivery' : ($billing['bill_type'] == 10 ? 'Chit PreClose' : ($billing['bill_type'] == 11 ? 'Repair Order' : ($billing['bill_type'] == 13 ? 'Sales Transfer' : ($billing['bill_type'] == 15 ? 'Approval Bill Acknowledgement' : 'Credit Collection'))))))))))))) . "" : ($billing['bill_status'] == 2 ? '- Cancelled' : '') ?>
				...
				<div class="content-wrapper" style="margin-top:20px;">
					<div class="box">
						<div class="box-body">
											...
											<div class="table-responsive">
												<table id="pp" class="table text-center">
													...
													<?php if ($total_sgst > 0) { ?>
														<tr>
															<td colspan="6"></td>
															<td class="alignLeft">SGST</td>
															<td class="alignLeft"><?php echo ($est_other_item['item_details'][0]['tax_percentage'] / 2) . '%' ?></td>
													...
													<?php if ($total_igst > 0) { ?>
														<tr>
															<td colspan="6"></td>
															<td class="alignLeft">IGST</td>
															<td class="alignLeft"><?php echo ($est_other_item['item_details'][0]['tax_percentage']) . '%' ?></td>
														...
														<table id="pp" class="table text-center" >
															...
															<tr>
																...
																<?php } else if($ord['advance_type'] == 2) { ?>
																	By Purchase Rec.No: 		
																<?php } ?>
																<?php echo $order_no ?> Dated <?php echo $ord['bill_date'] ?>
																</td>
							...
							<?php if (sizeof($est_other_item['return_details']) > 0) { ?>
								<span style="font-weight: bold">SALES CREDIT INVOICE NO : <?php echo  $billing['branch_code'] . '-SR-' . $billing['metal_code'] . '-' . $billing['s_ret_refno']; ?></span>
								...
								<table id="pp" class="table text-center">
									...
									<?php if (sizeof($est_other_item['item_details']) == 0 && sizeof($est_other_item['old_matel_details']) == 0) { ?>
									    <tr style="text-transform:uppercase;">
											...
											<td style="width: 22%" class="table_heading">Description</td>
											<td style="width: 15%" class="table_heading">HSN Code</td>
											<td style="width: 8%" class="table_heading">PURITY</td>
											<td style="width: 8%" class="table_heading alignRight">PCS</td>
											<td style="width: 8%" class="table_heading alignRight">Gwt</td>
									...
									?>
										...
										<tr>
											...
											<td style="width: 22%; font-size:10px;" class='textOverflowHidden'><?php echo $items['product_name']; ?></td>
											<td style="width: 15%"><?php echo $items['hsn_code']; ?></td>
											<td style="width: 8%"><?php echo $items['purname']; ?></td>
											<td style="width: 8%" class="alignRight"><?php echo $items['piece']; ?></td>
											<td style="width: 8%" class="alignRight"><?php echo $items['gross_wt']; ?></td>
                                        ...
                                        if(sizeof($items['rtn_stone_details']) > 0) {
                                            foreach ($items['rtn_stone_details'] as $stoneItems) { ?>
                                                    ...
                                                    <tr class="stones">
                                                        <td></td>
                                                        <td class='textOverflowHidden stoneData'><?php echo $stoneItems['stone_name']; ?></td>
                                                        <td style="width:10%;" class="aligncenter stoneData"><?php echo moneyFormatIndia(number_format((float)($stoneItems['wt']), 3, '.', '')) . '/' . $stoneItems['uom_short_code']; ?></td>


                                                        <td style="width:18%" class="alignRight stoneData"><?php echo $stoneItems['rate_per_gram'] . ' /  ' . $stoneItems['uom_short_code']; ?></td>

                                                        <td class="alignRight"></td>

                                                        <td style="width:18%" class="alignRight stoneData"><?php echo moneyFormatIndia('Rs : ' . $stoneItems['price']); ?></td>
										...
										<table id="pp" class="table text-center" style="width:100% !important">
											...
											<?php                                                
												...
												foreach($get_other_adv_details as $oth_adv) {
													...
													?>
													<tr>
														<td colspan="6" style="font-weight: bold;"><?php echo $adv_text.$order_no." Dated : ".date("d-m-Y", strtotime($oth_adv['bill_date']))." (Rate : ".$rate.")";?></td>
														<td class="alignLeft">Amount</td>
														<td class="alignLeft">Rs.</td>
												...
												<?php if($balance_type == 2) { ?>
													<tr style="font-weight: bold;">
														<td colspan="6"></td>
														<td class="alignLeft">Balance Amount</td>
														<td class="alignLeft">Rs.</td>
													...
													<tr style="font-weight: bold;">
														<td colspan="6"></td>
														<td class="alignLeft">Balance Metal</td>
						...
						<table id="pp" class="table text-center">
							...
							<?php if (sizeof($est_other_item['item_details']) == 0 || sizeof($est_other_item['old_matel_details']) > 0) { ?>
								...
								<tr style="text-transform:uppercase;">
									...
									<td style="width: 14%;" class="table_heading alignRight">GROSS WT</td>
									<td style="width: 15%;" class="table_heading alignRight">Calc.Wt</td>
									<td style="width: 15%;" class="table_heading alignRight">Amount</td>
								</tr>
								<tr>
							...
							?>
								<tr>
									...
									<td style="width: 14%" style="width: 9%" class="alignRight"><?php echo number_format($items['gross_wt'], 3, '.', ''); ?></td>
							...
							<?php if ($total_return > 0) { ?>
								<tr>
									<td colspan="2"></td>
									<td class="alignRight" colspan="2">Credit Amount</td>
									<td class="alignRight">Rs.</td>
									<td class="alignRight"><?php echo moneyFormatIndia(number_format($total_return, 2, '.', '')); ?></td>
								</tr>
							<?php } ?>
					...
					if ($cash_amt > 0 || $chq_amt > 0 || $card_amt > 0 || $rtgs_amt > 0 || $imps_amt > 0 || $adv_adj > 0 || $gift_amount > 0 || $billing['advance_deposit'] > 0) { ?>
						...
						<table id="pp" class="pay_mode_totals table text-left" style="width:40%;">
							<div align="left">
							...
							<tbody>
								...
								<?php if ($chq_amt > 0) { ?>
									<tr>
										<td>CHEQUE</td>
										<td class="alignRight"><?php echo moneyFormatIndia(number_format($chq_amt, 2, '.', '')); ?></td>
									</tr>
								<?php } ?>
							    ...
							    <?php if (($ord_adj_amt != 0 || $billing['adv_adj_amt'] != 0) && $deposit_bill_id=='') { ?>
									<tr>
										<td>ADV ADJ</td>
										<td class="alignRight"><?php echo moneyFormatIndia(number_format($ord_adj_amt + $billing['adv_adj_amt'], 2, '.', '')); ?></td>
									</tr>
								<?php } ?>
                                
                                <?php if (sizeof($billing['adjusted_in_sales']) > 0  ) {

									foreach ($billing['adjusted_in_sales'] as $adjusted_amt) { 
										
										if($adjusted_amt['deposit_bill_id']!=''){ ?>

										<tr>
											<td><?php echo $adjusted_amt['deposit_type'] == 1 ? ($adjusted_amt['metal'] != '' ? 'BY CUST OWN ' . $adjusted_amt['metal'] . ' EX' : 'BY CUST OWN EX') : ($adjusted_amt['deposit_type'] == 2 ? 'Credit Note ' : 'ADV ADJ')  ?></td>
											<td class="alignRight"><?php echo moneyFormatIndia(number_format($adjusted_amt['utilized_amt'], 2, '.', '')); ?></td>
											<td><?php echo  $adjusted_amt['deposit_type'] == 1 ? ($adjusted_amt['adjusted_bill_no']!='' ? '&nbsp;&nbsp; Ref Pur No : ' . $adjusted_amt['adjusted_bill_no'] : '') : ($adjusted_amt['deposit_type'] == 2 ? ($adjusted_amt['adjusted_bill_no']!='' ? '&nbsp;&nbsp; Ref  No : ' . $adjusted_amt['adjusted_bill_no'] : ''): '' )?>;</td>
								...
								<?php if ($billing['advance_deposit'] != 0) { ?>
									<tr>
										<td>ADVANCE</td>
										<td class="alignRight"><?php echo number_format($billing['advance_deposit'], 2, '.', '') ?></td>
									</tr>
								<?php } ?>
