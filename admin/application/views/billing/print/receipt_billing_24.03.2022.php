    ...
    <div>
			...
			<div style="width: 100%; text-transform:uppercase;">
				...
				<div style="display: inline-block; width: 50%; padding-left: 40px">
                   ...
                   <!-- <label><?php echo ($billing['cus_country']!='' ?$billing['cus_country'].','."<br>" :''); ?></label>-->
				</div>
				...
				<div style="width: 100%; text-align: right; display: inline-block; vertical-align: top; margin-top:-12px;">
					<div style="text-align: right; width:100%; height: 20px;">
						...
						<div style="text-align: left;width: 20%; display: inline-block;"> <?php echo $billing['branch_name'];?> </div>
					</div>
					<div style="text-align: right; width:100%; height: 18px;margin-top:1px;">
						<div style="width: 30%; display: inline-block"> Date &nbsp; : &nbsp; </div>
						<div style="text-align: left;width: 20%; display: inline-block;"> <?php echo $billing['bill_date']; ?></div>
					</div>
					<div style="text-align: right; width:100%; height: 20px;margin-top:-3px;">
						<div style="width: 30%; display: inline-block;"> GST Bill No &nbsp; : &nbsp; </div>
						<div style="text-align: left;width: 20%; display: inline-block;"> <?php echo ($billing['branch_code']!='' ? $billing['branch_code'].'/':'').($billing['fin_year_code']!='' ?$billing['fin_year_code'].'/' :'').($billing['bill_type']==1 || $billing['bill_type']==2 || $billing['bill_type']==3 || $billing['bill_type']==7 || $billing['bill_type']==9 ? 'SA/':($billing['bill_type']==4 ? 'PUR/' :$billing['bill_type']==5 ? 'OD/':'')).$billing['bill_no']; ?> </div>
					</div>
					<!--<div style="text-align: right; width:100%; height: 15px;margin-top:1px;">
						<div style="width: 30%; display: inline-block;">State &nbsp; : &nbsp; </div>
						<div style="text-align: left;width: 20%; display: inline-block;"> <?php echo $comp_details['state'].($comp_details['state_code']!='' ? '-'.$comp_details['state_code'] :'');?> </div>
					</div>-->

					<div style="text-align: right; width:100%; height: 15px;margin-top:1px;">
						<div style="width: 30%; display: inline-block;">GOLD &nbsp; : &nbsp; </div>
						<div style="text-align: left;width: 20%; display: inline-block;"> <?php echo number_format($gold_metal_rate,2,'.','').'/'.'Gm'; ?> </div>
					</div>

					<div style="text-align: right; width:100%; height: 15px;margin-top:1px;">
						<div style="width: 30%; display: inline-block;">SILVER &nbsp; : &nbsp; </div>
						<div style="text-align: left;width: 20%; display: inline-block;"> <?php echo $silver_metal_rate.'/'.'Gm'; ?> </div>
					</div>
			...
			<div style="width: 100%; display: inline-block; text-transform:uppercase; height:30px;"></div><br><br>
											...
											<table id="pp" class="table text-center">
												<!--	<thead> -->
														...
														<tr style="text-transform:uppercase;">
															<td style="width: 5%" class="table_heading">S.No</td>
															<td style="width: 25%;" class="table_heading">Metal</td>
			...
			<div class="row" style="display: none;">
                ...
                <label><?php echo ($billing['address1']!='' ?$billing['address1'].','."<br>" :''); ?></label>
                <label><?php echo ($billing['address2']!='' ?$billing['address2'].','."<br>" :''); ?></label>
                <label><?php echo ($billing['address3']!='' ?$billing['address3'].','."<br>" :''); ?></label>
                <label><?php echo ($billing['city']!='' ? $billing['city'].($billing['pincode']!='' ? ' - '.$billing['pincode'].'.' :''):''); ?><br></label>
                <label><?php echo ($billing['cus_state']!='' ?$billing['cus_state'].','."<br>" :''); ?></label>
			</div>
