                            ...
                            <div class="form-group">
                                <div class="col-md-3">
                                    ...
                                    <div class="input-group">
										...
										<input id="allow_other_bill_types" type="hidden" value="<?php echo set_value('billing[allow_other_bill_types]',$billing['allow_other_bill_types']); ?>" />
										<input id="ret_sales_type" type="hidden"  name="billing[ret_sales_type]" value="1" />
                						 		...
                						 		<div class="col-sm-8">
                						 			<div class="form-group" > 
                							 			<div class="input-group" > 
                											...
                											<input class="form-control" id="filter_bill_no" name="filter_bill_no" type="text" placeholder="Bill No." value="" style="width:100px;" tabindex=17/>
