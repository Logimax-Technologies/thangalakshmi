...
//	const BRANCH_TABLE     ="branch";
  ...
  //charges master 
   ...
   {
   	 $this->db->select('id_services,serv_code,serv_name,serv_email,serv_sms,dlt_te_id,serv_whatsapp');
	 ...
	 function settingsDB($type="",$id="",$set_array="")
   	{
   	    switch($type)
		{
			case 'get': 
	   	        if($id!=NULL)
	   	        {
					$sql="Select schemeaccNo_displayFrmt,isOTPReqToGift,giftOTP_exp,receiptNo_displayFrmt,
								id_chit_settings, 
								currency_symbol,
				...
				{
					$sql="Select  schemeaccNo_displayFrmt,receiptNo_displayFrmt,
								id_chit_settings, 
								currency_symbol,
								currency_name,
   ...
   function giftDB($type="",$id="",$gift_array="")
   {
	   	switch($type)
		{
	   	   case 'get': 
	   	        if($id!=NULL)
	   	        {
					$sql="Select * From gifts Where id_gift=".$id;
	   	 		    return $this->db->query($sql)->row_array();
				}
				else
				{
