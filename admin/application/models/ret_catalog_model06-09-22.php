...
class Ret_catalog_model extends CI_Model
{
 ...
 /*product functions here */ 	
	...
	*/
	...
	{
		$data = $this->db->query("SELECT id_karigar,CONCAT(firstname,' ',IFNULL(lastname,'')) as karigar,IFNULL(code_karigar,'') as code, karigar_for as karigartpe FROM `ret_karigar` WHERE status_karigar = 1");
		return $data->result_array();
	}
