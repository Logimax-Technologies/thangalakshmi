...

{
...

    {
        ...
        IFNULL(tagOtherMetal.tag_other_itm_amount,0) as tag_other_itm_amount,c.scheme_closure_benefit,c.id_ret_category
	...
	*/
...

    {
        ...
        IFNULL(tagOtherMetal.tag_other_itm_amount,0) as tag_other_itm_amount,cus.rate_per_gram as order_rate
