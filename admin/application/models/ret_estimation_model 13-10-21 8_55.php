...

{
...

	{
		...
		$sql = $this->db->query("SELECT estimation_id,esti_no,
				...
				cus.firstname as customer_name,e.emp_code,b.short_name ,e.id_employee,e.firstname as emp_name
...

	{
		...
		foreach ($item_details as $items) {
			...
			$return_data["item_details"][]=array(
							...
							'charges'			=> $this->get_charges($items['tag_id'])
...

    {
        ...
        IFNULL(lot_inw.order_no,'') as order_no,des.design_name,tag.tag_mark,r.rate_field,r.market_rate_field, rtc.charge_value
	...
	*/
...

    {
        ...
        d.design_name, rtc.charge_value
        FROM ret_taging tag
