...

{
	...
	//Bulk edit
...

	 {
			...
			m.tgrp_id as tax_group_id,IF(t.tag_mc_type=1,'Per Gram','Per Piece') as mc_type,IFNULL(s.sub_design_name,'-') as sub_design_name, IFNULL(rtc.charge_value, 0) AS charge_value
