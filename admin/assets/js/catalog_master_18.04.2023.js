		...
		success:function(data)
		{
			...
			if (list!= null && list.length > 0)
			{
				...
				$.each(list,function(key,val)
                {
					...
					"<td><select class='appr_va_type' class='form-control' style='width: 100px;'><option value='1' "+(val.wastage_type==1 ? 'selected' :'')+">Percentage</option><option value='2' "+(val.wastage_type==2 ? 'selected' :'')+">Weight</option></select></td>"+
					
					'<td class="wast_per"><input type="number" step="any" class="form-control appr_wast_percent" placeholder="wastages"  style="width: 100px;" value="'+val.wastage_per+'" '+(val.wastage_type==2 ? 'disabled' :'')+'/><input type="hidden" class="act_wast_per" value="'+val.wastage_per+'"></td>'+

					'<td class="wastage_wt"><input type="number" step="any" class="form-control appr_wast_wgt" placeholder="wastages"  style="width: 100px;" value="'+val.wastage_wt+'" '+(val.wastage_type==1 ? 'disabled' :'')+'/><input type="hidden" class="act_wast_wt" value="'+val.wastage_wt+'"></td>'+
					
					"<td><select class='appr_mc_type' class='form-control' style='width: 100px;' ><option value='1' "+(val.mc_type==1 ? 'selected' :'')+">Gram</option><option value='2' "+(val.mc_type==2 ? 'selected' :'')+">Piece</option></select></td>"+
					
					'<td class="mc_value"><input type="number" step="any" class="form-control appr_mc" placeholder="MC"  style="width: 100px;" value="'+val.mc_value+'"/></td>'+
...
function create_new_empty_karigar_product_detail()
{
		...
		$("#i_increment").val(i); 
			...
			html+="<tr id='detail"+i+"' class='"+i+"'>"+
				...
				"<td><select class='form-control category' name='o_item["+i+"][category]' id='category"+i+"' required='true' style='width: 150px;' placeholder='Search Category'/><input type='hidden' name='o_item["+i+"][id_category]' id='id_category"+i+"' required='true'/></td>"+

				"<td><select  class='form-control product' name='o_item["+i+"][product]' id='product"+i+"' required='true' style='width: 150px;' /><input type='hidden' name='o_item["+i+"][id_product]' id='id_product"+i+"' required='true'/></td>"+

				"<td><select  class='form-control design' name='o_item["+i+"][design]' id='design"+i+"' required='true' style='width: 150px;' /><input type='hidden' name='o_item["+i+"][id_design]' id='id_design"+i+"' required='true'/></td>"+

				"<td><select  class='form-control sub_design' name='o_item["+i+"][sub_design]' id='sub_design"+i+"' required='true' style='width: 150px;' /><input type='hidden' name='o_item["+i+"][id_sub_design]' id='id_sub_design"+i+"' required='true'/></td>"+

				"<td><select  class='form-control purity' name='o_item["+i+"][purity]' id='purity"+i+"' required='true' style='width: 150px;' /><input type='hidden' name='o_item["+i+"][id_purity]' id='id_purity"+i+"' required='true'/></td>"+

				"<td><select  class='form-control kar_calc_type' name='o_item["+i+"][kar_calc_type]' style='width: 150px;'><option value=''>Select Type</option><option value='1'  >Pure Weight x Rate</option><option value='2' >Purchase Touch</option><option value='3' >Pure Weight x Wastage %</option></select></td>"+
				...
				"<td><select  class='form-control calc_type' name='o_item["+i+"][calc_type]' style='width: 150px;'><option value=''>Select Type</option><option value='0'  >Mc & Wast On Gross</option><option value='1' >Mc & Wast On Net</option><option value='2' >Mc on Gross,Wast On Net</option></select></td>"+

				"<td><select ' class='form-control va_type' name='o_item["+i+"][va_type]' style='width: 150px;'><option value='1' selected>Percentage</option><option value='2'>Weight</option></select></td>"+

				"<td class='va_per'><input type='number' class='form-control wast_percent' placeholder='Wast %' name='o_item["+i+"][wast_percent]' required='true' style='width: 100px;'/></td>"+

				"<td class='va_wt' style='display:none'><input type='number' class='form-control wast_wgt' placeholder='Wast Wgt' name='o_item["+i+"][wast_wgt]' required='true' style='width: 100px;'/></td>"+

				"<td><select  class='form-control mc_type' name='o_item["+i+"][id_mc_type]' style='width: 150px;'><option value='1'>Gram</option><option value='2' selected>Piece</option></select></td>"+
	...
	$.ajax({
        ...
        success: function (data) { 
	        ...
	        $.each(data.karigar_wastages, function (key, item) {
				...
				"<td><select class='kar_calc_type' class='form-control' name='o_item["+i+"][calc_type]' style='width: 100px;'disabled    ><option value='1' "+(item.calc_type==1 ? 'selected' :'')+">Pure Weight x Rate</option><option value='2' "+(item.karigar_calc_type==2 ? 'selected' :'')+">Purchase Touch</option><option value='3' "+(item.karigar_calc_type==3 ? 'selected' :'')+">Pure Weight x Wastage %</option></select></td>"+
                ...
                "<td class='va_per' style='"+(item.wastage_type==2 ? "display:none;":"display:block;")+"'><input type='number' class='form-control wast_percent' placeholder='wastages ' name='o_item["+i+"][wastage]' required='true' value='"+item.wastage_per+"' id='wastage"+i+"' style='width:100px;' "+(item.karigar_calc_type==2 ? 'disabled' :'')+" disabled /></td>"+
