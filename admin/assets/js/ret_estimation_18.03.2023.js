                ...
                success:function(data){
                    ...
                    {           
            			        ...
            			        if(!rowExist)
                                {
                                    ...
                                    +'<td><input class="act_mc_value"  name="est_tag[mc][]" type="number" value='+data[0].tag_mc_value+' /><input class="discount_amount"  name="est_tag[discount_amount][]" type="hidden" value="" /></td>'
                    ...
                    {   
            					 ...
            					 var rowExist=false;
            					     ...
            					     if(!rowExist)
            					     {
                                                ...
                                                //+'<td><div class="mc">'+data[0].tag_mc_value+'</div></td>'
                                                +'<td><input class="act_mc_value"  name="est_tag[mc][]" type="number" value='+items.tag_mc_value+' /><input class="discount_amount"  name="est_tag[discount_amount][]" type="hidden" value="" /></td>'
                                                +'<td><a href="#" onClick="create_new_empty_est_cus_stone_item($(this).closest(\'tr\'));" class="btn btn-success"><i class="fa fa-plus"></i></a><input type="hidden" class="stone_details" name="est_tag[stone_details][]" value='+JSON.stringify(stone_details)+'><input type="hidden" class="stone_price" name="est_tag[stone_price][]"></td>'
	...
	var rowId = new Date().getTime();
       row += '<tr id="'+rowId+'">'
		...
		/*	+'<td><div class="mc"></div></td>'*/
			+'<td><input class="act_mc_value"  name="est_tag[mc][]" type="number" value="" /><input class="discount_amount"  name="est_tag[discount_amount][]" type="hidden" value="" /></td>'
					...
					{   
						...
						$.each(data.responseData,function(key,item){
							...
							if(!rowExist)
								...
								+'<td><input class="act_mc_value"  name="est_tag[mc][]" type="number" value="'+item.tag_mc_value+'"  /><input class="discount_amount"  name="est_tag[discount_amount][]" type="hidden" value="" /></td>'
