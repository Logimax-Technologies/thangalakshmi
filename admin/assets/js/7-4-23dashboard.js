	...
	function set_customer_link(from_date="",to_date="")
{
	...
	//alert(id_branch);
	// var customer_url=base_url+'index.php/reports/detail/registration_bydate/'+from_date+"/"+to_date;
	// var customer_without_acc_url=base_url+'index.php/customer/withoutAccount_bydate/'+from_date+"/"+to_date;
	// var account_without_pay_url=base_url+'index.php/account/withoutPayment_bydate/'+from_date+"/"+to_date;
