...

        {
...

        	{
        		...
        		$.each(data.lot_inward_detail, function (key, item) {
        		    ...
        		    $('#tag_wast_perc').val(item.wastage_percentage);
                    $('#tag_mc_value').val(item.making_charge);
                    $('#tag_id_mc_type').val(item.mc_type);
...
$(document).on('input keyup', '#tag_pcs,#tag_gwt,#tag_lwt,#tag_wast_perc,#tag_mc_value,#tag_id_mc_type,#tag_calculation_based_on,#tag_sell_rate,#purchase_rate', function(e){
                  ...
                  if(items.id_lot_inward_detail==curRow.closest('tr').attr('id'))
                    {
                        ...
                        if(items.id_lot_inward_detail==curRow.closest('tr').attr('id'))
                        {
                            ...
                            {
                                total_used_wt+=parseFloat(curRow.find('.net_wt').val());
	...
	if(this.id == 'tag_pcs') {
		...
		if(tag_blc_pcs >0){
			if(tag_input_pcs > tag_blc_pcs){
				...
				//$("#tag_blc_pcs_disp").html("Blc : "+parseFloat(tag_act_blc_pcs-tag_input_pcs));
		...
		if(tag_blc_wgt >0){
			if(tag_input_wgt > tag_blc_wgt)
			{
				...
				$("#tag_blc_gross_disp").html(0);
			}else if(tag_input_wgt < 0){
				var blc_wt = tag_blc_wgt-1;
				$("#tag_gwt").val(1);
				$("#tag_blc_gross_disp").html(parseFloat(blc_wt).toFixed(3));
			}
			else{
				var blc_wt = tag_blc_wgt-tag_input_wgt;
			    $("#tag_blc_gross_disp").html(parseFloat(tag_act_gross_blc-$('#tag_gwt').val()-total_used_wt).toFixed(3));
			   //$("#tag_blc_gross_disp").html(parseFloat(blc_wt).toFixed(3));
			}
		}
	}
