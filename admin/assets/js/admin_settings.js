...
$('#ed_dept').on('keyup', function()
{
	...
	if(!regexp.test(dept))
	{
		$("#ed_dept").val("");
		$.toaster({ priority : 'error', title : 'Warning!', message : ''+"</br>Special Characters not allowed ,Only Space and Alphabets allowed ..."});
		$('#ed_dept').attr('placeholder', 'Enter a valid Designation Name');
		$("#ed_dept").focus();
	}
});
...
$("#add_design").on('click',function()
{
	...
	var design_name=$('#designation').val();
	if(design_name!='')
	...
	{
		$.toaster({ priority : 'error', title : 'Warning!', message : ''+"</br>Designation Name Should not be Empty ..."});
		$('#designation').attr('placeholder', 'Enter a valid Department Name');
		$("#designation").focus();
		return false;
	}
	});	
