...
$(document).on("change","#bulk_edit_options",function() {
    ...
    $(".mc_type_block,.mc_value_block, .bulk_edit_wastage, .va_block, .mrp_value_block, .gross_wt_block, .less_wt_block, .net_wt_block, .pcs_block, .update_lot_block, .purity_block, .attribute_block,.size_block,.image_block,.charges_block,.huid_block, .old_tag_id_block").css("display","none");
...
function get_lot_inwards_detail(lot_no,lot_product,lot_id_design)
{
	...
	my_Date = new Date();
        ...
        data: {'lot_no':lot_no,'lot_product':lot_product,'lot_id_design':lot_id_design,'is_split':$('#is_lot_split').val(),'id_employee':id_emp},
        type:"POST",
        dataType:"JSON",
        success:function(data)
        {
