	...
	function add_karigar_wastage()
	{
		if(validate_karigar_wastages()) {
			let _html_add = '<div class="row wastages">'+					       
								...
								'<div class="col-md-1">'+
									'<div class="form-group">'+
										'<input class="form-control wastage_value" style="width:80px;" name="karigar[wastage][value][]"  type="number" placeholder="Wastage Value" />'+
									'</div>'+
								'</div>'+
								
								'<div class="col-md-2">'+
									'<div class="form-group">'+
									'<select class="form-control mc_type" name="karigar[wastage][mc_type][]" placeholder="Mc Type"><option value="1">Per Grm</option><option value="2">Per Pcs</option></select>'+
									'</div>'+
								'</div>'+

								'<div class="col-md-1">'+
									'<div class="form-group">'+
										'<input class="form-control mc_value" style="width:80px;" name="karigar[wastage][mc_value][]"  type="number" placeholder="MC Value" />'+
									'</div>'+
								'</div>'+
...
/*Karigar Stones */
	...
	function add_karigar_stones()
	{
		...
		let _html_add = '<div class="row stones">'+
							...
							'<div class="col-md-2">'+
								'<div class="form-group">'+
									'<select class="form-control stn_calc_type" name="karigar[stone][stn_calc_type][]" placeholder=" Type"><option value="1">Gram</option><option value="2">Pcs</option></select>'+					
								'</div>'+
							'</div>'+
		...
		success:function(data)
		{
			...
			if (list!= null && list.length > 0)
			{
				...
				$.each(list,function(key,val)
                {
					...
					'<td class="stn_type">'+val.stone_type+'<input type="hidden" class="stone_type" name="stone_type[]" value='+val.stone_type_id+'></td>'+

					'<td class="stn_name">'+val.stone_name+'<input type="hidden" class="stone_name" name="stone_name[]" value="'+val.stone_id+'"></td>'+

					'<td class="stn_uom">'+val.uom_name+'<input type="hidden" class="uom_name" name="uom_name[]" value="'+val.uom_name+'"></td>'+

					'<td class="stn_calc_type">'+val.stn_calc_type+'</td>'+
...
function karigarApprovedList(approved_data)
{
	...
	postData={'approved_data':approved_data,'status':status};
