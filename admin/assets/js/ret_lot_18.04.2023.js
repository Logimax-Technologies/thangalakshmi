...
$('#add_lots').on('click',function()
{
	if($("#id_gold_smith").val() != "")
	{
		if(validateLotMergeRow())
		{
			create_new_empty_lot_row_for_merge();
		}
		else
		{
			alert("Please fill current Row fields");
		}
	}else{
		alert("Please fill required fields");
	}
...
function validateLotMergeRow(){
	...
	{		 		
		if($(this).find('.lm_pro').val() == ""  || $(this).find('.lm_purity').val() == "" || $(this).find('.lm_pcs').val() == "" || $(this).find('.gross_wt').val()=="")
		{
			row_validate = false;
		}
...
function create_new_empty_lot_row_for_merge()
{
	var row = "";
	var stock_type = $('#stock_type:checked').val();
	...
	row += '<tr id='+i+'>'
		...
		+'<td><select class="lm_purity" name="merge_item['+i+'][lm_purity]" value="" placeholder="Search Design" style="width:150px;"><input type="hidden" class="lm_id_purity" name="merge_item['+i+'][lm_id_purity]" value="" /></td>'

		+'<td><input type="number" step="any" value="" name="merge_item['+i+'][pcs]" class="lm_pcs" style="width:60px;"></td>'

		+'<td><div class="input-group"><input type="number" step="any" value="" name="merge_item['+i+'][gross_wt]" class="gross_wt" style="width:80px;" autocomplete="off"><span class="input-group-addon input-sm no-padding" style="background-color: transparent;height: 12px;font-size: 16px;border: none;"><select class="gross_wt_uom" name="merge_item['+i+'][gross_wt_uom]">'+uom+'</select></span></div></td>'

		+'<td><div class="input-group"><input type="number" step="any" onClick="show_stone_modal($(this).closest(\'tr\'),'+i+');" value="" name="merge_item['+i+'][less_wt]" class="lot_lwt" style="width:80px;" autocomplete="off"><span class="input-group-addon" onClick="show_stone_modal($(this).closest(\'tr\'));">+</span><span class="input-group-addon input-sm no-padding" style="background-color: transparent;height: 12px;font-size: 16px;border: none;"><select class="less_wt_uom" name="merge_item['+i+'][less_wt_uom]">'+uom+'</select><input type="hidden" class="precious_stone" name="merge_item['+i+'][precious_stone]"/><input type="hidden" class="precious_stone_pcs" name="merge_item['+i+'][precious_st_pcs]"/><input type="hidden" class="precious_stone_wt" name="merge_item['+i+'][precious_st_wt]"><input type="hidden" class="p_stn_certif_uploaded" name="merge_item['+i+'][p_stn_certif_uploaded]"><input type="hidden" class="precious_st_certif" name="merge_item['+i+'][precious_st_certif]"><input type="hidden" class="semi_precious_stn" name="merge_item['+i+'][semi_precious_stn]"/><input type="hidden" class="semi_precious_st_pcs" name="merge_item['+i+'][semi_precious_st_pcs]"/><input type="hidden" class="semi_precious_st_wt" name="merge_item['+i+'][semi_precious_st_wt]"><input type="hidden" class="sp_stn_certif_uploaded" name="merge_item['+i+'][sp_stn_certif_uploaded]"><input type="hidden" class="semiprecious_st_certif" name="merge_item['+i+'][semiprecious_st_certif]"><input type="hidden" class="normal_stn" name="merge_item['+i+'][normal_stn]"/><input type="hidden" class="normal_st_pcs" name="merge_item['+i+'][normal_st_pcs]"/><input type="hidden" class="normal_st_wt" name="merge_item['+i+'][normal_st_wt]"><input type="hidden" class="normal_st_certif" name="merge_item['+i+'][normal_st_certif]"><input type="hidden" class="n_stn_certif_uploaded" name="merge_item['+i+'][n_stn_certif_uploaded]"><input type="hidden" name="merge_item['+i+'][nor_wt_uom]" class="nor_wt_uom"><input type="hidden" name="merge_item['+i+'][semi_wt_uom]" class="semi_wt_uom"><input type="hidden" name="merge_item['+i+'][pre_wt_uom]" class="pre_wt_uom"></span></div></td>'


		+'<td><div class="input-group"><input type="number" step="any" value="" name="merge_item['+i+'][net_wt]" class="lot_nwt" style="width:80px;" autocomplete="off"><span class="input-group-addon input-sm no-padding" style="background-color: transparent;height: 12px;font-size: 16px;border: none;"><select class="net_wt_uom" name="merge_item['+i+'][net_wt_uom]">'+uom+'</select></span></div></td>'

		+'<td><input type="number" step="any" class="wastage_percentage" name="merge_item['+i+'][wastage_percentage]" style="width:60px;"></td>'

		+'<td><div class="input-group"><input type="number" step="any" class="making_charge" name="merge_item['+i+'][making_charge]" style="width:70px;"><span class="input-group-addon input-sm no-padding" style="background-color: transparent;height: 12px;border: none;"><select class="form-control mc_type" style="width:80px;height: 29px;" name="merge_item['+i+'][id_mc_type]" autocomplete="off"><option value="1">Gram</option><option value="2" selected>Piece</option></select></span></div><input type="hidden" value=""  class="id_mc_type"></td>'

		+'<td><div class="input-group"><input type="number" step="any" class="size" name="merge_item['+i+'][size]" style="width:70px;"><span class="input-group-addon input-sm no-padding" style="background-color: transparent;height: 12px;border: none;"></span></div></td>'
