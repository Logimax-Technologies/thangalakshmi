	...
	*/
	...
	$('#des_des_name').on('change',function(e){
...

		{
    		 ...
    		 $("#get_tag_details").removeAttr("disabled");
	...
	$('#confirm_update_bulk_design').on('click',function(){
	    ...
	    if($("input[name='bedit_des_id[]']:checked").val())

        {
    		...
    		$("#edit_mas_design_list tbody tr").each(function(index, value){
        		...
        		if($(value).find("input[name='bedit_des_id[]']:checked").is(":checked"))

        		{

    		    	transData = { 

            			'design_no'   	 :  $(value).find(".bedit_des_id").val(),

            			'mc_cal_type'    :  $('#update_mc_type').val(),

            			'mc_cal_value'   :  $('#mc_value').val(),

            			'wastag_value'   :  $('#wastage_percent').val()
...
//update material
	...
	*/
	...
	$("#add_user,#add_newuser").on('click',function(){

		var file=$("#user_img")[0].files[0];

		if($("#first_name").val() != '' && $("#user_name").val() != '' && $("#password").val() != ''){

			add_user($("#first_name").val(),

			$("#last_name").val(),$("#user_name").val(),$("#password").val(),$("#karigar_code").val(),

			$("#address1").val(),$("#address2").val(),$("#address3").val(),($("#country").val()!=null ? $("#country").val():''),($("#state").val()!=null ? $("#state").val():''),($("#city").val()!=null ? $("#city").val():''),$("#email").val(),

			$("#phone").val(),$("#mobile").val(),$("#company").val(),$("#user_status").val(),file);
			...
			msg='<div class = "alert alert-danger"><a href = "#" class = "close" data-dismiss = "alert">&times;</a><strong>Warning!</strong> Enter first name.</div>';				
			...
			msg='<div class = "alert alert-danger"><a href = "#" class = "close" data-dismiss = "alert">&times;</a><strong>Warning!</strong> Enter user name.</div>';				
			...
			msg='<div class = "alert alert-danger"><a href = "#" class = "close" data-dismiss = "alert">&times;</a><strong>Warning!</strong> Enter Password.</div>';				
	...
	$(document).on('click', "#karigar_list a.btn-edit", function(e) {
	...
	$("#update_user").on('click',function(){ 
		...
		var id=$("#edit-id").val();
			...
			var file=$("#ed_user_img")[0].files[0]; 

			var firstname=$("#ed_first_name").val();

			var lastname=$("#ed_last_name").val();

			var user_name=$("#ed_user_name").val();

			var password=$("#ed_password").val();

			var code=$("#ed_karigar_code").val();

			var address1=$("#ed_address1").val();

			var address2=$("#ed_address2").val();

			var address3=$("#ed_address3").val();

			var country=$("#ed_country").val();
			...
			var company=$("#ed_company").val();

			var status=$("#ed_user_status").val();

		if($("#ed_first_name").val() != '' && $("#ed_user_name").val() != '' && $("#ed_password").val() != ''){

				update_user(firstname,lastname,user_name,password,code,address1,address2,address3,country,state,city,email,phone,mobile,company,status,file);

			}

			else if($("#ed_first_name").val() == ''){
	...
	*/
	...
	$('#select_product').on('change',function(e){
...

		{
			...
			set_design_table($('#design1').text(),$('#design2').text(),this.value);
...

{
	...
	success:function(data){
		...
		$.each(data, function (key, item) {   
		    ...
		    $("#product_sel,#filterproduct_sel,#select_product,#sel_prod,#prod_select,#ed_prod_select,#ret_product,#ed_size_product").append(
		...
		$("#product_sel,#filterproduct_sel,#select_product,#sel_prod,#prod_select,#ed_prod_select,#ret_product,#ed_size_product").select2(
