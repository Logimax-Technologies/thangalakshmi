			 ...
			 success:function(data){
				...
				{  	
					...
					$.each(list, function (i, item) { 
						    ...
						    var chit_url = base_url+'index.php/reports/payment/account/'+item.scheme_account_id;
								trHTML += '<tr>'
												...
												+'<td>'+parseFloat(item.closing_amount).toFixed(2)+'</td>'
				    	...
				    	trHTML += '<tr style="font-weight:bold;">' +
										...
										+'<td></td>'
										+'<td>Sub Total</td>'
										+'<td>'+parseFloat(closing_amt).toFixed(2)+'</td>'
										+'<td>'+parseFloat(sch_benefits).toFixed(2)+'</td>'
										+'<td></td>'
					    		 '</tr>';
					...
					trHTML += '<tr style="font-weight:bold;">' +
									...
									+'<td></td>'
									+'<td>Grand Total</td>'
									+'<td>'+parseFloat(total_closing_amount).toFixed(2)+'</td>'
									+'<td>'+parseFloat(total_sch_benefits).toFixed(2)+'</td>'
									+'<td></td>'
				    		 '</tr>'; 	
					...
					$.each(list, function (i, category) { 
						 ...
						 $.each(category, function (idx, item) {
						    ...
						    trHTML += '<tr>' +
									...
									'<td><strong>' + parseFloat(dia_wt).toFixed(3) + '</strong></td>' +
					 ...
					 trHTML += '<tr>' +
									...
									'<td><strong>' + parseFloat(total_dia_wt).toFixed(3) + '</strong></td>' +
                                        ...
                                        "footerCallback": function( row, data, start, end, display ){
                                            ...
                                            if(list.length>0)
                                            {
                                                ...
                                                for( var i=0; i<=data.length-1;i++)
                                                {
                                                    ...
                                                    $(api.column(5).footer()).html(parseFloat(total_bill_amount).toFixed(2));
                                                    ...
                                                    $(api.column(6).footer()).html(parseFloat(total_due_amount).toFixed(2));
                                                    ...
                                                    $(api.column(7).footer()).html(parseFloat(total_paid_amount).toFixed(2));
                                                    ...
                                                    $(api.column(8).footer()).html(parseFloat(total_return_amount).toFixed(2));
...
function get_po_payment_details(){
    ...
    var branch_name='';
	var company_name=$('#company_name').val();
	var title="<b><span style='font-size:15pt;margin-left:30%;'>"+company_name+"</span></b><b><span style='font-size:12pt;'></span></b></br>"+"<span style=font-size:13pt;margin-left:25%;>&nbsp;&nbsp;SUPPLIER PAYMENT REPORT "+($("#branch_select").val()!='' ? "COST CENTER:"+branch_name+" ":'')+" From&nbsp;:&nbsp;"+dt_range[0]+" &nbsp;&nbsp;To Date&nbsp;:&nbsp;"+dt_range[1]+"</span>";
...
function itemwise_sales_detail()
{
	...
	var title = "<div style='text-align: center;'><b><span style='font-size:15pt;'>" + company_name + "</span></b><b><span style='font-size:12pt;'></span></b></br>"
		+ "<span>" + report_print(branch_name, report_name, from_date, to_date, optional) + "</span>";my_Date = new Date();
	my_Date = new Date();
	$(".overlay").css("display", "block");	 
	$.ajax({		
	 	type: 'POST',		
        						...
        						{ 
									if(data.length>0){
										...
										for( var i=0; i<=data.length-1;i++){
											...
											$(api.column(4).footer()).html(parseFloat(opvalue).toFixed(2));*/
											...
											$(api.column(5).footer()).html(parseFloat(inpcs).toFixed(0));
											...
											$(api.column(8).footer()).html(parseFloat(opvalue).toFixed(2));*/
											...
											$(api.column(9).footer()).html(parseFloat(outpcs).toFixed(0));
											...
											$(api.column(10).footer()).html(parseFloat(outgwt).toFixed(3));
											...
											$(api.column(11).footer()).html(parseFloat(outnwt).toFixed(3));
											...
											$(api.column(13).footer()).html(parseFloat(clpcs).toFixed(0));
											...
											$(api.column(14).footer()).html(parseFloat(clgwt).toFixed(3));
											...
											$(api.column(15).footer()).html(parseFloat(clnwt).toFixed(3));
