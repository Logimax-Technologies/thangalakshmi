...
$(document).ready(function() {
	...
	*/
    ...
    function get_Active_sub_desingns()
...
//update material
	...
	*/
	...
	$("#add_categorynew,#add_newcategory").on('click',function(){
		...
		if($("#category_name").val() != '' && $("#id_metal_category").val() != '' && $("#cat_code").val() != '' && $("#pur_id").val() != '' && $("#hsn_code").val() != '' && $("#tgrp_sel").val() != '' && (is_multimetal == 0 || is_multimetal == 1)){

			var file = $("#categorymtr_img")[0].files[0];

			add_categorymtr($('#category_name').val(),$('#cat_code').val(),$('#category_desc').val(),$('#id_metal_category').val(),$('#pur_id').val(),$('#add_category_status').val(),file,$("#hsn_code").val(), is_multimetal,$("#tgrp_sel").val())
    ...
    $("#update_category").on('click',function(){	
		...
		if($("#ed_category_name").val() != ''  && $("#id_metal_cate").val() != '' && $("#ed_cate_code").val() != '' && $("#ed_hsn_code").val() != '' && $('#ed_tgrp_sel').val()!='' && $('#ed_tgrp_sel').val()!=null && (is_multimetal == 0 || is_multimetal == 1)){

	    	update_categorymtr(name,cat_code,description,id_metal,id_purity,status,file,hsn_code,is_multimetal,$('#ed_tgrp_sel').val());
...
function add_categorymtr(name,cat_code,description,id_metal,id_purity,status,file,hsn_code,is_multimetal,tag_group)
...
function update_categorymtr(name,cat_code,description,id_metal,id_purity,status,file,hsn_code,is_multimetal,tgrp_id)
...
$("#add_weight").on('click',function(){
...

    {
        ...
        add_weight(name,from_weight,to_weight,id_product,id_design,uom, weight_desc);
...
$("#update_weight").on('click',function(){
...

		{
		    ...
		    update_weight(name,from_weight,to_weight,id_product,id_design,uom,id, weight_desc);
...
function add_weight(name,from_weight,to_weight,id_product,id_design,uom, weight_desc)

{
	...
	$.ajax({
		...
		data:{'name':name,'from_weight':from_weight,'to_weight':to_weight,'id_product':id_product,'id_design':id_design,'uom':uom, 'weight_desc' : weight_desc},
...
function update_weight(name,from_weight,to_weight,id_product,id_design,uom,id, weight_desc)
...
$('#des_select,#ed_des_select').on('change',function(){
    ...
    if(this.value!='' && id_product!='')
    {
        $('#ed_wt_select option').remove();
        setTimeout(function(){ 
            get_wt_range_product(id_product,this.value);
        }, 1000);
    }
    if(ctrl_page[1]=='reorder_settings')
    {
