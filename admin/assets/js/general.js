...
if($('#branch_set').val()==1  && ctrl_page[0] != 'settings' && ctrl_page[1] != 'payment_employee_wise' && ctrl_page[1] != 'payment_daterange' && ctrl_page[1] != 'Employee_account' && ctrl_page[1] != 'payment_datewise_schemedata' && ctrl_page[1] != 'branch_transfer'  ){		
	 	get_branchname();			
	}
