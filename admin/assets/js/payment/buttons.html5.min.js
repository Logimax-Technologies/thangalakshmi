...
var _fnGetHeaders=function(r){for(var a=$(r.header()[0]).children(),t=a.length,e=[],v=0;v<t;v++)for(var n=$(a[v]).children("th"),o=0;o<n.length;o++){var f=$(n.get(o)),h=f.attr("colspan")||1,l=f.attr("rowspan")||1,d=0;void 0===e[v]&&(e[v]=[]);for(var g=0;g<e[v].length&&"PLACEHOLDER"!==e[v][g];g++,d++);var i=d;e[v][d++]=f.text();for(var g=1;g<h;g++)e[v][d++]="";for(var c=1;c<l;c++){var E=v+c;void 0===e[E]&&(e[E]=[]);for(var g=e[E].length;g<i;g++)e[E][g]="PLACEHOLDER";for(var g=0;g<h;g++)e[E][i+g]=""}}return e};
return o.Buttons});
