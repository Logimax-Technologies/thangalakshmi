...
<html>
	...
	<body>
		 ...
		 <form id="cashfreepayment" action='https://test.cashfree.com/billpay/checkout/post/submit' target="_self" method='post'>
		<!--<form id="cashfreepayment" action='https://www.cashfree.com/checkout/post/submit' target="_self" method='post'>-->
