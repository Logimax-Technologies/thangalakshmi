...
<html>
	...
	<body>
		 ...
		 <form id="web_payment" action='https://test.payu.in/_payment' target="_self" method='post'>


		<!--<form id="web_payment" action='https://secure.payu.in/_payment.php' target="_self" method='post'>-->
		...
		<input type="hidden" name="furl" value="<?php echo $pay['furl'];?>" />
			...
			<input type="hidden" name="address1" value="<?php echo $pay['address1'];?>" />

			<input type="hidden" name="address2" value="<?php echo $pay['address2'];?>" />

			<input type="hidden" name="country" value="<?php echo $pay['country'];?>" />

			<input type="hidden" name="state" value="<?php echo $pay['state'];?>" />

			<input type="hidden" name="city" value="<?php echo $pay['city'];?>" />

			<input type="hidden" name="zipcode" value="<?php echo $pay['zipcode'];?>" />
