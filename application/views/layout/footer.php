            ...
            <div class="">
				<div class="row footer">
					<div class="col-md-4 col-xs-12 viswa_copyright"> &copy; <?php echo date("Y"); ?> <a href="<?php echo base_url(); ?>" ><?php echo $footer_data['company_name'].'.'?> </a>  All Rights Reserved. </div>
				
					<!-- /span6 --> 
					<div class="col-md-4 col-xs-12" style="margin-top: 9px;text-align:center;"><p> 			
						<!--Links disabled-->	
					...
					<div class="col-md-4 col-xs-12 log_link"  align="right">Powered by <a target="_blank" href="http://www.logimaxindia.com/"><img src="<?php echo base_url('assets/img/logimax.png');?>"/></a></div>
					<!-- /span6 -->
					<!-- /span6 --> 
				</div>
						  <!-- /row --> 
...
================================================== --> 
<script>
	var cus_ref_code = "<?php echo $this->session->userdata('reference_no')?>";
</script>
...
<?php } else if($page == 'dashboard' || $page == 'my_schemes') {  ?>
...
<script src="<?php echo base_url() ?>assets/js/pages/changeUser.js"></script> 
<?php } else if($page == 'vs_appt') {  ?>
<script src="<?php echo base_url() ?>assets/js/pages/vs_appt.js"></script>
<?php } else if($page == 'jwl_adv_pay') {  ?>
<script src="<?php echo base_url() ?>assets/js/pages/jwl_adv_pay.js"></script>
<?php } ?>
