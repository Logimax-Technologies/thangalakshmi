		...
		<div class="col-md-12"> 
			...
			<div class="">
				...
				<?php 
					...
					echo form_open_multipart('jap_appt_book/add',$attributes);  
				?> 
						...
						<div class="" align="center">
							...
							<div class="cus_form">    
								<div class="form-group"> 
									<input type="number" id="jap_mobile" name="mobile" value="" class="form-control" placeholder="Mobile Number" pattern="\d{10}" required/>
									<span class="note"> Verify your mobile number and book online advance.</span>
								</div> 
							</div>
