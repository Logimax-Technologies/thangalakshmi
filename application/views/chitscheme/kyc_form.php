						...
						<div class="widget-content">
							...
							<div class="col-md-12">
								<div class="tab-pane active">					
									...
									<div id="tab_kyc_content" class="tab-content col-md-10">
										<div class="tab-pane overflow active" id="tab_bank">
											...
											echo form_open( 'chitscheme/kyc_details', $attributes);
											?> 
											<div class="col-md-12 row marginBottom15">
												<label class="col-md-6" for="firstname"> <b>IFSC Code<span class="error"> * </span> 		</b></label>
												<div class="col-md-6">
											...
											<div class="col-md-12 row marginBottom15">								
												<label class="col-md-6" for="firstname"> <b>Account Number<span class="error"> * </span> 		</b></label>
												<div class="col-md-6">
													<input type="password" id="bank_acc_no" name="bank[bank_acc_no]" value="<?php echo set_value('bank[bank_acc_no]',isset($kyc['bank']['number'])?$kyc['bank']['number']:NULL); ?>" placeholder="Account Number" class="form-control" required />
												</div> 		
											</div><!---->
											<div class="col-md-12 row marginBottom15">									
												<label class="col-md-6" for="firstname"> <b>Confirm Account Number<span class="error"> * </span> 		</b></label>
												<div class="col-md-6">
											...
											<!--<div class="col-md-12 row marginBottom15">											
											<label class="col-md-6" for="firstname"> <b>A/c Holder Name<span class="error"> * </span> 		</b></label>
											<div class="col-md-6">
											...
											<div class="col-md-12 row marginBottom15">											
											<label class="col-md-6" for="firstname"> <b>Bank Branch<span class="error"> * </span> 		</b></label>
											<div class="col-md-6">
											<input type="text" id="bank_branch" name="bank[bank_branch]" value="<?php echo set_value('bank[bank_branch]',$kyc['bank']['bank_branch']); ?>" placeholder="Bank Branch" class="form-control" required />
											</div> 		
											</div>-->
										...
										<div class="tab-pane overflow" id="tab_pan">
											...
											?> 
											<div class="col-md-12 row marginBottom15">										
												<label class="col-md-6" for="firstname"> <b>PAN Number<span class="error"> * </span> 		</b></label>
												<div class="col-md-6">
													<input type="text" id="pan_no" name="pan_no" value="<?php echo set_value('pan[pan_no]',isset($kyc['pan']['number']) ? $kyc['pan']['number'] : NULL); ?>" placeholder="10 Digit PAN number" style='text-transform:uppercase' class="form-control" required />
												</div> 		
											</div><!---->
											<div class="col-md-12 row marginBottom15">									
												<label class="col-md-6" for="firstname"> <b>PAN Card Holder Name<span class="error"> * </span> 		</b></label>
												<div class="col-md-6">
													<input type="text" id="pan_card_name" name="pan_card_name" value="<?php echo set_value('pan[pan_card_name]',$kyc['pan']['name']); ?>" placeholder="Card Holder Name" class="form-control" required />
												</div> 		
											</div><!---->
										...
										<div class="tab-pane overflow" id="tab_aadhar">
											...
											<div class="col-md-12 row marginBottom15">										
												<label class="col-md-6" for="firstname"> <b>Aadhaar Number<span class="error"> * </span> 		</b></label>
												<div class="col-md-6">
													<input type="text" id="aadhar_number" name="aadhar_number" value="<?php echo set_value('aadhar[aadhar_number]',isset($kyc['aadhar']['number'])?$kyc['aadhar']['number']:NULL ); ?>" maxlength="12" placeholder="12 Digit UID Number" class="form-control"  />
												</div> 		
											</div><!---->
											<div class="col-md-12 row marginBottom15">
												<label class="col-md-6" for="firstname"> <b>Aadhaar Holder Name<span class="error"> * </span> 		</b></label>
												<div class="col-md-6">
												<input type="text" id="aadhar_cardname" name="aadhar_cardname" value="<?php echo set_value('aadhar[aadhar_cardname]',isset($kyc['aadhar']['name'])? $kyc['aadhar']['name'] : NULL); ?>" placeholder="Card Holder Name" class="form-control"  />
												</div> 		
											</div><!---->
											<div class="col-md-12 row marginBottom15">										
												<label class="col-md-6" for="firstname"> <b>Date of Birth<span class="error"> * </span> 		</b></label>
												<div class="col-md-6">
													<input type="date" id="dob" name="dob" value="<?php echo set_value('aadhar[dob]',isset($kyc['aadhar']['dob'])?$kyc['aadhar']['dob']:NULL); ?>" placeholder="D.O.B" class="form-control"  />
												</div> 		
											</div>
											<?php } ?>
											<?php if($kyc['aadhar']['status'] != 'Verified') { ?>
										...
										<div class="tab-pane overflow" id="tab_dl">
											...
											<div class="col-md-12 row marginBottom15">										
												<label class="col-md-6" for="firstname"> <b>Driving Licence Number<span class="error"> * </span> 		</b></label>
												<div class="col-md-6">
