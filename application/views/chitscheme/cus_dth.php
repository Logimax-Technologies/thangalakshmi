	...
	<div class="main" >
		...
		<div class="main-inner">
			...
			<div class="container">
				<div class="row">
					<div class="span6">
						<div align="center"><legend class="head">Booked Appointments</legend></div>
						<?php
							...
							<table id="cuscomplaint_list" class="table table-bordered table-striped table-responsive display" >
								...
								<tbody>
									...
									<tr>
										...
										<td><?php echo($record['type']==5?'DTH':'EXPERIENCE CENTER'); ?></td>
										<td><a href="<?php echo base_url('index.php/user/custDthStatus/'.$record['id_enquiry'])?>"  class="btn btn-primary btn-single btn-mini pay_submit" >View</a>
										</td>
									</tr>
									<?php $i++; } 
									?>
